...
import { LayoutProvider } from '@/context/layout-provider' // ✅ Standardized import
import './globals.css'
    ...
    >
      ...
      >
        {/* 🛠️ GLOBAL STATE BRIDGE
            Placing LayoutProvider at the very root ensures that components in /app
            and nested layouts can all access the 'Full Size' layout state.
        */}
        <LayoutProvider>
          {children}
        </LayoutProvider>
