...
// ✅ FIXED: Importing the secure confirmation guard for revocation
  ...
  return (
    <div className="space-y-10 p-4 sm:p-8 pb-32 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* ✅ FIXED: Unique key for hydration safety */}
                  ...
                  >
                    ...
                    <td className="px-10 py-8 text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent
                          align="end"
                          className="w-[240px] rounded-[2rem] border-border/50 shadow-2xl p-3 bg-card/95 backdrop-blur-2xl"
                        >
                          <DropdownMenuItem
                            asChild
                            className="rounded-xl font-black uppercase text-[10px] py-4 tracking-widest cursor-pointer focus:bg-primary focus:text-white transition-all"
                          >
                          ...
                          {/* ✅ FIXED: Integrated the secure confirmation guard */}
                          <RevokeServiceButton serviceId={service.id} />
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </td>
                  </tr>
