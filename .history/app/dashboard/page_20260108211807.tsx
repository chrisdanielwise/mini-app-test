 ...
 * Optimized for stateless JWT auth and Neon Serverless performance.
 */
export default async function DashboardPage() {
  // 1. Authenticate - uses the high-speed stateless JWT bridge
  ...
  try {
    /**
     * 🏁 THE NEON RACE (v2.0)
     * We trigger parallel fetching but add a 15s timeout safety net.
     * This 15s window covers the "Cold Start" period where Neon wakes up.
     */
      ...
      (await Promise.race([
        ...
        new Promise((_, reject) =>
          setTimeout(
            ...
            15000 // 🏁 Increased to 15s for better Neon wake-up reliability
          )
        ),
      ])) as any;
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-3xl bg-primary p-6 text-primary-foreground shadow-lg shadow-primary/20">
                ...
                <p className="text-xs font-bold leading-relaxed opacity-90">
                  Full-screen mode is enabled. Swiping is disabled to protect your live data sessions.
                </p>
              </div>
            </div>
          </div>
    ...
    /**
     * 🛡️ RETRY UI (Cold Start Handler)
     * Triggered if Neon times out or connection is lost.
     */
    return (
