...
import { Ticket, Users, MoreHorizontal } from "lucide-react"
import { 
  Table, 
  TableBody, 
  TableCell, 
...
import { CreateCouponModal } from "@/components/dashboard/create-coupon-modal" // ✅ Added Import
  ...
  return (
    <div className="space-y-6 p-6 pb-20">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* ✅ Interactive Modal replaces the static Button */}
        <CreateCouponModal />
      </div>
