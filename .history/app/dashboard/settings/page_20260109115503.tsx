      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section className="space-y-6 pt-6 border-t border-border">
            <div className="flex items-center gap-2 text-emerald-500">
              ...
              <h2 className="text-[10px] font-black uppercase tracking-[0.2em]">Viewport & Experience</h2>
            </div>
        ...
        <div className="space-y-6">
          <div className="rounded-[2.5rem] bg-card border border-border p-8 shadow-xl">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-primary mb-6">System Status</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                <CheckCircle2 className="h-4 w-4 text-emerald-500" />
                <span className="text-[10px] font-bold uppercase">Webhooks Online</span>
              </li>
            </ul>
