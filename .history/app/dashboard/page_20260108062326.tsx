...
export default async function DashboardPage() {
   ...
   * requireMerchantSession will now physically delete the 'auth_token' cookie 
   * if the session is invalid, which breaks the infinite redirect cycle.
   */
   ...
   * Using Promise.all minimizes wait time by triggering all DB queries at once.
   */
    ...
    <div className="space-y-8 p-6 pb-20">
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Welcome back, <span className="font-bold text-foreground">{session.user.fullName || "Merchant"}</span>. Here is your business at a glance.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatsCard
          title="Total Revenue"
          // Formats string Decimal from Prisma safely
          value={`$${parseFloat(revenueAnalytics.total).toLocaleString(undefined, { 
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
            <div className="mb-6">
              ...
              <p className="text-xs text-muted-foreground font-medium">Manage your operations</p>
            </div>
            ...
            <div className="grid gap-4">
              ...
              >
                ...
                <div>
                  <p className="text-sm font-bold uppercase tracking-tight">New Service</p>
                  <p className="text-[10px] text-muted-foreground font-medium">Setup a subscription plan</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-bold uppercase tracking-tight">Create Coupon</p>
                  <p className="text-[10px] text-muted-foreground font-medium">Run a promotional offer</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-primary p-6 text-primary-foreground shadow-lg shadow-primary/20">
            ...
            <p className="mt-2 text-xs font-bold leading-relaxed opacity-90">
              Users are 40% more likely to renew when you offer a yearly discount tier. Check your Service settings to add a "Lifetime" or "Yearly" option.
            </p>
          </div>
        </div>
      </div>
