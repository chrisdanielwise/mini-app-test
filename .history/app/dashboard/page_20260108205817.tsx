...
export default async function DashboardPage() {
  ...
  try {
    /**
     * 🏁 THE NEON RACE
     * 15s Timeout to account for Neon Cold Starts.
     */
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-3xl bg-primary p-6 text-primary-foreground shadow-lg shadow-primary/20">
                ...
                <p className="text-xs font-bold leading-relaxed opacity-90">
                  Native Full-Screen mode is enabled. Swiping to close is disabled to prevent data loss.
                </p>
              </div>
            </div>
          </div>
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[100vh] text-center space-y-6 bg-background">
