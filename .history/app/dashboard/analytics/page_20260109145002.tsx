...
import { TrendingUp, CreditCard, Activity, Users, Ticket, Zap, PieChart as PieIcon } from "lucide-react";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
             ...
             <span className="text-[9px] font-black uppercase tracking-[0.3em] text-emerald-500">Live Node Analytics</span>
          </div>
          <h1 className="text-4xl font-black tracking-tighter uppercase italic leading-none">
            Performance
          </h1>
          <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mt-2 opacity-70">
            Cluster: <span className="text-foreground">{session.merchant.companyName || "Global Root"}</span>
          </p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="rounded-[2.5rem] border-primary/20 bg-gradient-to-br from-primary/[0.08] via-transparent to-transparent shadow-2xl shadow-primary/5 overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-4 pt-8 px-8">
            <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">Gross Revenue</CardTitle>
          ...
          <CardContent className="px-8 pb-8">
            ...
            <div className="flex items-center gap-1.5 mt-2 text-emerald-500">
               ...
               <p className="text-[9px] font-black uppercase tracking-widest">+12.4% Momentum</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-[2.5rem] border-border/50 bg-card/50 backdrop-blur-md shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between pb-4 pt-8 px-8">
            <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Active Nodes</CardTitle>
            <Users className="h-5 w-5 text-muted-foreground opacity-30" />
          </CardHeader>
          <CardContent className="px-8 pb-8">
            <div className="text-4xl font-black tracking-tighter italic">{stats.activeSubscriptions.toLocaleString()}</div>
            <p className="text-[9px] font-bold text-muted-foreground mt-2 uppercase tracking-widest opacity-60">Verified User Instances</p>
          </CardContent>
        </Card>

        <Card className="rounded-[2.5rem] border-border/50 bg-card/50 backdrop-blur-md shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between pb-4 pt-8 px-8">
            <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Pending Tickets</CardTitle>
            <Ticket className="h-5 w-5 text-muted-foreground opacity-30" />
          </CardHeader>
          <CardContent className="px-8 pb-8">
            <div className={cn("text-4xl font-black tracking-tighter italic", stats.pendingTickets > 0 ? "text-amber-500" : "text-foreground")}>
              {stats.pendingTickets}
            </div>
            <p className="text-[9px] font-bold text-muted-foreground mt-2 uppercase tracking-widest opacity-60">Protocol Support Queue</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 rounded-[3rem] border border-border/50 bg-card/30 backdrop-blur-xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-12 gap-4 relative">
            ...
            <div className="px-4 py-2 rounded-xl bg-muted/50 border border-border text-[9px] font-black uppercase tracking-widest">Protocol: USD</div>
          </div>
        ...
        <div className="rounded-[3rem] border border-border/50 bg-card/30 backdrop-blur-xl p-8 shadow-2xl flex flex-col">
          ...
          <div className="mt-8 p-4 rounded-2xl bg-muted/20 border border-border/50">
             <p className="text-[8px] font-black uppercase text-muted-foreground tracking-widest text-center">
               Portfolio diversification provides risk mitigation across asset categories.
             </p>
          </div>
        </div>
