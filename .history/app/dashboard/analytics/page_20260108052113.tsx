  ...
  return (
    <div className="space-y-8 p-6 pb-10">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black tracking-tight uppercase italic">Analytics</h1>
          <p className="text-sm text-muted-foreground">Performance tracking for {session.merchant.companyName}</p>
        </div>
