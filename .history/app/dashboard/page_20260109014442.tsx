...
/**
 * 🛠️ FIXED IMPORTS: 
 * These must use Default Imports to match your component exports.
 */
...
export default async function DashboardPage() {
  /**
   * 🔐 1. SESSION FETCH
   * Validates the JWT cookie and retrieves the Merchant Profile from Neon.
   */
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[2.5rem] bg-primary p-6 text-primary-foreground shadow-lg shadow-primary/20">
              ...
              <p className="text-xs font-bold leading-relaxed opacity-90">
                Full-screen immersion active. GreysuitFx dashboard is live via Ngrok.
              </p>
            </div>
          </div>
        </div>
 ...
 * Optimized for Zipha V2's premium rounded corner aesthetic.
 */
