...
function ChartPlaceholder() {
  return <div className="h-[300px] w-full animate-pulse rounded-[2.5rem] bg-muted/50 border border-border/50" />;
}

function ActivityPlaceholder() {
  return <div className="h-[400px] w-full animate-pulse rounded-[2.5rem] bg-muted/50 border border-border/50" />;
}
