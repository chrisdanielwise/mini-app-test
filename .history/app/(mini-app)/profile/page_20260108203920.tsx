...
export default function ProfilePage() {
  ...
  /**
   * 🚀 THE BRIDGE REDIRECT:
   * This function forces the browser to the Auth Callback.
   * It ensures the Stateless JWT is set as a cookie before entering the dashboard.
   */
  const handleSwitchToDashboard = (e: React.MouseEvent) => {
    ...
    if (merchantId && telegramId) {
      ...
      alert("Merchant data is still loading. Please wait a few seconds and try again.");
    }
  };
  ...
  return (
    <div className="min-h-screen space-y-6 bg-background pb-20">
      ...
      <div className="space-y-8 px-4">
        {/* MERCHANT TOOLS SECTION - ONLY VISIBLE TO ADMINS/MERCHANTS */}
        {isMerchant && (
          <section className="space-y-4 rounded-3xl border border-primary/20 bg-primary/5 p-4 shadow-sm">
            <div className="flex items-center justify-between px-1">
              ...
              <Badge className="bg-primary text-[9px] font-black italic">
                LIVE HUB
              </Badge>
            </div>
