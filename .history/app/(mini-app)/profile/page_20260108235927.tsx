...
export default function ProfilePage() {
  ...
  const handleSwitchToDashboard = (e: React.MouseEvent) => {
    ...
    const merchantId = syncedMerchantId || auth.user?.merchantId || auth.user?.merchantProfile?.id;
    ...
    if (merchantId && telegramId) {
      ...
      alert("Establishing secure link to GreysuitFx... Please tap again in 2 seconds.");
    }
  };
