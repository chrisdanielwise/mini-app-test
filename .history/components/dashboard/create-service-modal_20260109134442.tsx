...
export function CreateServiceModal({ merchantId }: CreateServiceModalProps) {
  ...
  const [tiers, setTiers] = useState([
    { id: Date.now(), name: "", price: "", interval: "MONTHLY", type: "STANDARD" }
  ]);
  ...
  useEffect(() => {
    if (state?.success && !isPending) {
      ...
      setTiers([{ id: Date.now(), name: "", price: "", interval: "MONTHLY", type: "STANDARD" }]);
    }
  }, [state, isPending]);

  const addTierRow = () => {
    setTiers([...tiers, { id: Date.now(), name: "", price: "", interval: "MONTHLY", type: "STANDARD" }]);
  };
            ...
            <div className="space-y-6 pt-10 border-t border-border/50">
              ...
              <div className="space-y-4">
                {tiers.map((tier, index) => (
                  <div key={tier.id} className="grid grid-cols-12 gap-4 p-6 rounded-[2rem] bg-muted/20 border border-border/50 items-end animate-in slide-in-from-right-4 duration-300 group">
                    ...
                    <div className="col-span-4 sm:col-span-3 space-y-2">
                      <Label className="text-[8px] font-black uppercase opacity-50">Cycle</Label>
                      <select
                        name="tierIntervals[]"
                      ...
                      <input type="hidden" name="tierTypes[]" value="STANDARD" />
                    </div>
