...
export function toast({ ...props }: Omit<ToasterToast, "id">) {
 ...
 // 🏁 TACTILE SYNC: Native feedback for the Telegram Node
  if (typeof window !== "undefined") {
    if (props.variant === "destructive") {
      hapticFeedback("error");
    } else {
      // Light impact for informative toasts, success for success variants
      hapticFeedback(props.variant === "default" ? "light" : "success");
    }
  }
