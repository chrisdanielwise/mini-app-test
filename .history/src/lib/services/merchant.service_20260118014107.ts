...
import {
  ...
  TicketStatus,
  PayoutStatus,
} from "@generated/prisma"; // 🚩 Using actual generated Enum types
...
// =================================================================
// 🕵️ TELEMETRY EXPORTS (Hardened v16.16.24)
// =================================================================
...
export const getGlobalPlatformStats = cache(async () => {
  // 🏛️ Parallel Execution: Aggregate global data using Schema Enums
