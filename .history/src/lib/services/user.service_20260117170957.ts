 ...
 * Fix: Revalidate IDENTITY profile to refresh session data.
 */
...
/**
 * 🔄 UPDATE_USER_PROFILE
 * Fix: Implements CACHE_PROFILES.IDENTITY ("auth") for profile refreshes.
 */
export async function updateUser(userId: string, data: any) {
  ...
  return withRetry(async () => {
    ...
    // 🚀 PURGE: Force every node to drop old profile data
    revalidateTag("auth", CACHE_PROFILES.IDENTITY);
 ...
 * Optimization: Uses indexed relation joins.
 */
