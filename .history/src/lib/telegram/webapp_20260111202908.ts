...
/**
 * 🛠️ UTILITY FUNCTIONS (Fully Restored & Fixed)
 */
...
/**
 * Native App Mode Initialization (v8.0)
 * Call this once at the top of your layout or dashboard
 */
export function initializeNativeAppMode() {
  ...
  // 🛡️ API 8.0 Fullscreen
  if (WebApp.version >= "8.0" && typeof WebApp.requestFullscreen === "function") {
    WebApp.requestFullscreen();
  }

  // 🛰️ VIEWPORT TELEMETRY: Inject native safe areas into CSS
  // This allows you to use var(--tg-safe-top) in your Tailwind padding
