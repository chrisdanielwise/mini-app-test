...
export const JWT_SECRET = process.env.JWT_SECRET || "zipha_secure_node_secret_2026_institutional";export const JWT_SECRET_UINT8 = new TextEncoder().encode(RAW_SECRET);
