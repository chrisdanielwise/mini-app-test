...
/**
 * 🛰️ PAYMENTS_CLIENT (Hardened v16.16.73)
 * Strategy: High-Density Signal Ledger & Stationary Tactical Horizon.
 * Fix: Overscroll-contain and z-index isolation for smooth momentum.
 */
export default function PaymentsClientPage({ initialTransactions = [], isSuperAdmin, role }: any) {
  ...
  return (
    ...
    >
      {/* --- COMMAND HUD HEADER: Stationary Anchor --- */}
      ...
      {/* --- LEDGER DATA GRID: Independent Volume --- */}
      <div className={cn(
