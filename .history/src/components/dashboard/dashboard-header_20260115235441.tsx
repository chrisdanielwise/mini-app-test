 ...
 * Behavioral Logic: morphology-aware visibility logic based on device-ingress.
 */
    ...
    >
      ...
      <div className="flex items-center gap-4 md:gap-7 shrink-0 relative z-10">
        ...
        <div className="relative group">
           <NotificationGroup />
           {/* Unread Signal */}
           <div className="absolute top-1 right-1 size-1.5 rounded-full bg-primary animate-pulse shadow-[0_0_10px_#10b981]" />
        </div>
