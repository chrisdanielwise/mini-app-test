 ...
 * Strategy: Vertical Compression & Stationary Command HUD.
 * Fix: High-density rows (py-3.5) and h-11 utility profile prevents blowout.
 */
export function SupportTicketQueue({ tickets }: { tickets: SupportTicket[] }) {
  ...
  return (
    <div className="flex flex-col h-full w-full min-w-0 overflow-hidden space-y-4">
      ...
      <div className={cn(
        ...
        <div className="relative w-full md:max-w-xs lg:max-w-md group">
          ...
          <Input 
            ...
            className="pl-10 h-11 rounded-xl border-white/5 bg-zinc-950/60 font-black text-[9px] uppercase tracking-[0.2em] italic"
          />
        </div>
        <div className="flex gap-2 w-full md:w-auto">
          ...
          <Button 
            ...
            className={cn(
              "flex-1 md:flex-none h-11 px-6 rounded-xl font-black uppercase tracking-widest text-[8px] shadow-lg italic",
      ...
      <div className="flex-1 min-h-0 w-full overflow-y-auto custom-scrollbar space-y-3 px-1">
        {filteredTickets.length === 0 ? (
          <div className="flex h-64 flex-col items-center justify-center opacity-10 italic">
          ...
          filteredTickets.map((ticket, index) => (
            <div 
              ...
              className={cn(
                ...
                "bg-zinc-950/40 border-white/5 hover:bg-white/[0.02] py-3.5 px-5 animate-in fade-in slide-in-from-bottom-2",
      ...
      >
         <div className="flex items-center gap-3">
            ...
            <p className="text-[7.5px] font-black uppercase tracking-[0.3em]">
              Support_Mesh_v16.31_Stable
            </p>
         </div>
         <span className="text-[7.5px] font-mono tabular-nums">[AES_256_ENCRYPTED]</span>
      </div>
    </div>
  );
}
