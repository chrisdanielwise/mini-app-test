 ...
 * Fix: Standardized h-14/h-16 footprint prevents vertical blowout.
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 md:gap-4 shrink-0 ml-4">
        ...
        <div className="hidden sm:block h-6 w-px bg-white/5 mx-1" />
        ...
        >
          ...
          {!isMobile && (
            <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-10 transition-opacity">
