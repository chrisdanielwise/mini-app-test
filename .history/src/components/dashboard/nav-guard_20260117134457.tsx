  ...
  return (
    <div className="sticky top-0 z-[100] w-full">
      ...
      <nav
        ...
        style={{ paddingTop: isMobile ? `calc(${safeArea.top}px * 0.25)` : "0px" }} // (UNTOUCHED)
      >
              ...
              <Sheet>
                <SheetTrigger asChild>
                  <Button 
                    ...
                    className={cn(
      "size-8 rounded-lg bg-white/5 border border-white/10",
      /* 🏁 NUDGE: Move it down and right to clear the 'Close' text */
      "mt-4 ml-2" 
    )}
                  >
                    <Menu className={cn("size-3.5", isStaffFlavor ? "text-amber-500" : "text-primary")} />
                  </Button>
                </SheetTrigger>
