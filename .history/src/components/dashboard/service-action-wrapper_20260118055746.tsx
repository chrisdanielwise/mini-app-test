 ...
 * Integration: Merged Legacy Danger Zone logic with Hardened 2026 Chassis.
 */
  ...
  return (
    <DropdownMenu onOpenChange={handleOpenChange}>
      ...
      <DropdownMenuContent
        ...
        sideOffset={8}
        className={cn(
          "bg-zinc-950/95 backdrop-blur-2xl p-2 shadow-3xl z-[100] border-white/5 animate-in zoom-in-95 duration-300",
          isMobile ? "w-[210px] rounded-2xl" : "w-[240px] rounded-[1.8rem]"
        )}
      >
        {/* --- 🛡️ FIXED HUD: Institutional Header --- */}
        ...
        {/* ⚠️ DANGER ZONE: High-Friction Metadata */}
        <div className="px-3.5 py-2 mb-1 flex items-center gap-2 opacity-40">
           <Shield className="size-3 text-rose-500 shrink-0" />
           <p className="text-[7.5px] font-black uppercase tracking-[0.3em] text-rose-500 italic">
            Danger_Zone
           </p>
        </div>
