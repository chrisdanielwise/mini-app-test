...
export function RecentPayments({ payments, className }: RecentPaymentsProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="shrink-0 border-b border-white/5 px-6 py-5 flex items-center justify-between bg-white/[0.02] relative z-10">
        ...
        <div className="space-y-2.5">
          {payments.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 opacity-10 border-2 border-dashed border-white/5 rounded-3xl">
              ...
              <p className="text-[9px] font-black uppercase tracking-[0.4em] italic">Awaiting_Sync_Protocol</p>
            </div>
          ) : (
            payments.map((payment, index) => (
              ...
              >
                <div className="flex items-center gap-4 min-w-0">
                  {/* Avatar Node: Institutional Shielded Icon */}
                ...
                <div className="text-right flex flex-col items-end shrink-0 ml-4">
                  <p className="text-base md:text-lg font-black italic tracking-tighter text-foreground tabular-nums leading-none">
