 ...
 * Alignment Fix: Tactical mt-3 and ml-2 to clear Telegram Mini App native buttons.
 */
  ...
  return (
    <header 
      className={cn(
        ...
        themeAmber ? "bg-amber-500/[0.01] border-amber-500/10 shadow-sm" : "bg-black/60 border-white/5 shadow-2xl"
      )}
    >
      
      {/* --- LEFT: MOBILE TRIGGER / DESKTOP IDENTITY --- */}
      ...
      {isMobile ? (
        <div className="flex flex-col items-center leading-none absolute left-1/2 -translate-x-1/2">
          {/* Visual Nudge to align with lower Hamburger position */}
          <div className="mt-3">
      ...
      <div className="flex items-center gap-3 shrink-0">
        <div className="mt-3 flex items-center gap-3">
          ...
          >
            <Bell className={cn("size-4", themeAmber ? "text-amber-500/20" : "text-white/10")} />
