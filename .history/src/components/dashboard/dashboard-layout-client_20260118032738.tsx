...
/**
 * 🛰️ DASHBOARD_LAYOUT_CLIENT (Institutional v16.16.82)
 * Strategy: Viewport-Locked Shell & Independent Tactical Scroll.
 * Mission: Orchestrate HUD, Ingress Sentinel, and Financial Ingress Nodes.
 */
export function DashboardLayoutClient({ children, userRole }: DashboardLayoutClientProps) {
  ...
  // 💓 HEARTBEAT SYNC: Feeds the sentinel and the stationary NavGuard pulse
    ...
    <div className="flex flex-col h-[100dvh] w-full bg-black overflow-hidden relative selection:bg-primary/30">
      ...
      <main 
        className={cn(
          ...
          "[-webkit-overflow-scrolling:touch]", // Momentum Handshake
      ...
      >
        <div className="relative min-h-full w-full">
          {!mounted || !isReady ? (
            ...
            // 🏎️ PAGE_INGRESS: Content flows inside the reservoir
            <div 
            ...
            >
              ...
              {/* 💡 LEDGER_REGISTRY: 
                These components are ready for injection. If you want to show 
                global ledger activity on the main dashboard, they can be 
                uncommented or conditionally rendered here.
              */}
              {/* <PaymentsLedger /> */}
              {/* <PayoutLedger /> */}
            </div>
