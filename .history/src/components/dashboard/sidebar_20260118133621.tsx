...
/**
 * 🛰️ DASHBOARD_SIDEBAR (Institutional Apex v2026.1.20)
 * Strategy: Pure Content Module & Vertical Compression.
 * Fix: Removed internal mobile triggers to prevent "Phantom" ghosting.
 * Fix: Standardized for Sheet-Portal injection.
 */
export function DashboardSidebar({ context }: { context: any }) {
  const pathname = usePathname();
  const { flavor } = useLayout();
  ...
  return (
    ...
    >
      ...
      {/* 🏁 SYNC: We remove the manual paddingTop here as SheetContent handle it */}
