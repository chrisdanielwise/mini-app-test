 ...
 * Fix: Header is physically pushed below safe area via a non-collapsible spacer.
 */
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      <header className="h-14 shrink-0 flex items-center px-4 bg-black/40 backdrop-blur-3xl border-b border-white/5 z-50">
