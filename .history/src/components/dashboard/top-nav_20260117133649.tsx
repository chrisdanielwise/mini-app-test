 ...
 * Fix: Removed redundant safeArea padding (handled by RootLayout Global Buffer).
  ...
  return (
    <header 
      className={cn(
        ...
        // 🛡️ TACTICAL COMPRESSION: h-14 (56px) is the world standard for high-density mobile apps
      ...
      // 🏁 Note: Padding-top is REMOVED because your RootLayout Buffer handles it.
    >
...
className={cn(
                  ...
                  /* 🛡️ TACTICAL ALIGNMENT: 
                     Pushes the icon down and right to clear the Telegram 'Close' button.
                     mt-3 aligns vertically with the Sheet Close button (+26px logic). */
                  "mt-3 ml-2" 
                )}
              >
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <Button 
          ...
          className={cn(
            "relative size-9 md:size-11 rounded-xl border transition-all active:scale-90 group",
