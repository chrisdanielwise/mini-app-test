...
export function NavGuard({
  ...
  if (!mounted || !isReady) {
    return (
      <nav className=" w-full border-b border-white/5 bg-black/40 h-12 flex items-center px-4 animate-pulse">
                ...
                <SheetTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      ...
                      /* 📐 PERFECT ALIGNMENT: 
         Buffer (18px) + mt-2 (8px) = 26px.
         This matches the Sheet Close button exactly. */
                      "mt-8 ml-2"
                    )}
                  >
                    {/* <Menu
