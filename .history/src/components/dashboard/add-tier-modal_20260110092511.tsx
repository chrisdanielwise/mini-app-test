          ...
          <div className="p-10 space-y-10">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <Label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1 text-primary">Identity Label</Label>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1 text-primary">Liquidity Price (USD)</Label>
                  <div className="relative">
                    <Input
                      name="price"
                      type="number"
                ...
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1 text-primary">Asset Class</Label>
                  <select
                    name="type"
              ...
              {/* --- Billing Logic --- */}
              <div className="space-y-3">
                <Label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1 text-primary">Billing Protocol</Label>
                <select
                  name="interval"
                  className="w-full h-14 rounded-2xl border border-border/40 bg-muted/10 px-4 text-[10px] font-black uppercase tracking-widest cursor-pointer outline-none focus:ring-2 focus:ring-primary/20 transition-all appearance-none"
                >
