 ...
 * Adaptive: Shifts visual accent (Amber/Emerald) based on operator context.
 */
export function StatsCard({
  ...
  iconType,
  iconColor, // Now dynamically computed if not provided
  className,
}: StatsCardProps) {
  ...
  // Adaptive Icon Color based on Flavor
  const activeIconColor = iconColor || (isStaff ? "text-amber-500" : "text-primary");
