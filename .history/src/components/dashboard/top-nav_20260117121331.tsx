 ...
 * Accessibility Fix: Included SheetHeader & SheetTitle with sr-only to resolve Radix error.
 */
  ...
  return (
    ...
    >
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button 
                ...
                className="size-10 rounded-xl bg-white/5 border border-white/10 active:scale-95"
              >
            ...
            <SheetContent side="left" className="w-[280px] p-0 bg-zinc-950 border-r border-white/5">
              ...
              {/* 🛡️ ACCESSIBILITY FIX: Required for Radix Dialog/Sheet Compliance */}
              <SheetHeader className="sr-only">
                <SheetTitle>Terminal_Navigation_Mesh</SheetTitle>
              </SheetHeader>

              {/* Technical Branding for Context */}
      ...
      {isMobile ? (
        <div className="flex flex-col items-center leading-none">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            ...
            <span className="text-[9px] font-black uppercase tracking-tighter text-foreground italic uppercase">Sync_OK</span>
          </div>
        </div>
      ) : (
      ...
      <div className="flex items-center gap-3 md:gap-4 shrink-0">
        ...
        {/* Identity Badge (Mobile Right Side) */}
