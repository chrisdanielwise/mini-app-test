      ...
      >
        <div className="relative min-h-full w-full">
          {!mounted || !isReady ? (
            ...
            <div 
              className="animate-in fade-in slide-in-from-bottom-2 duration-700 p-4 md:p-10 space-y-6"
              style={{ 
            ...
            >
              {/* 📊 TACTICAL LEDGER STACK (Optional Dashboard Quick-View) */}
              {/* Note: In a production environment, these are often fed by a specialized useTransactions() hook */}
