    ...
    <aside className={cn(
      ...
      <div className="flex items-center gap-3 border-b border-white/5 px-5 shrink-0 bg-white/[0.01] h-14 leading-none">
        ...
        <div className="flex flex-col min-w-0">
          <span className={cn("font-black tracking-[0.25em] uppercase text-[7px] italic", themeAmber ? "text-amber-500/40" : "text-primary/40")}>
            NODE_v16.apex
          </span>
        ...
        {filteredNav.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className={cn("absolute left-0 w-0.5 h-4 rounded-full", themeAmber ? "bg-amber-500" : "bg-primary")} />
              )}
            </Link>
          );
        })}
