 ...
 * Normalized: Fluid typography and responsive grid constraints for cross-device parity.
 * Optimized: Resilient touch-targets and viewport-safe modal geometry.
 */
        ...
        <form action={formAction} className="flex flex-col h-full overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-5 sm:p-10 space-y-6 sm:space-y-10 scrollbar-hide">
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              {/* --- Financial Grid: Responsive Stack --- */}
