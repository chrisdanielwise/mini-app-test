  ...
  return (
    ...
    <div className="flex flex-col h-[100dvh] w-full bg-black overflow-hidden relative selection:bg-primary/30">
      ...
      {/* 🛰️ STATIONARY HUD (Z-50)
          🏁 THE FIX: shrink-0 + z-50 pins the global navigation at the top.
      */}
      <header 
      ...
      {/* 🌊 TIER 2: LAMINAR RESERVOIR 
          🏁 THE FIX: overflow-hidden + flex-1. This is a rigid window. 
      ...
      >
        <div className="h-full w-full">
          {!mounted || !isReady ? (
            ...
            /* 🏎️ PAGE_INGRESS: Fills 100% of remaining chassis height. */
