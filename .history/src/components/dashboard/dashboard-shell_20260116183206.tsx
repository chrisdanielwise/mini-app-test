...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  useLayoutEffect(() => {
    ...
    // Paste this into Eruda after the app has been open for 5 seconds
const tg = window.Telegram?.WebApp;
console.log("--- 🏁 POST-HYDRATION CHECK ---");
console.log("Notch Height:", tg?.safeAreaInset?.top);
console.log("Bottom Height:", tg?.safeAreaInset?.bottom);
