                  ...
                  >
                    <TableCell className="px-10 py-8">
                      <div className="flex items-center gap-6">
                        ...
                        <div className="flex flex-col">
                          <p className="font-black text-foreground uppercase italic tracking-tighter text-sm group-hover:text-primary transition-colors">
                            @{tx.user.username || 'anon_node'}
                          </p>
                          <p className="text-[8px] font-mono font-bold text-muted-foreground/20 uppercase mt-1">
                    ...
                    <TableCell className="px-10 py-8">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-[10px] uppercase italic text-muted-foreground/60">
