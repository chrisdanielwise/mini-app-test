  ...
  return (
    ...
    >
      {/* 🚀 LAYER 1: STATIONARY_HUD_HEADER
          We apply a HARD margin-top here. This physically forces the element down. */}
      <header 
        className="shrink-0 pt-2 pb-4 flex flex-col px-4 bg-black/40 backdrop-blur-3xl border-b border-white/5 z-50"
        style={{ 
          marginTop: `${Math.max(safeArea.top, 27)}px !important` as any, // 🛰️ FORCE DISPLACEMENT
        }}
      >
