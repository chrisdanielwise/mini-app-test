 ...
 * Organization: 
 * - Mobile: [Hamburger] ---- [Telemetry/Status] ---- [Notifications/Identity]
 * - Desktop: [Brand/Identity] ---- [Global Search] ---- [Actions/Systems]
 */
export function DashboardTopNav({ context }: { context: any }) {
  ...
  const { isReady, isMobile,saf } = useDeviceContext();
