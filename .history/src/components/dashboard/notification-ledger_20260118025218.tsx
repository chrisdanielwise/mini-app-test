...
/**
 * 🛰️ NOTIFICATION_LEDGER (Refined v16.16.68)
 * Strategy: High-Density Signal History & Vertical Compression.
 * Fix: Standardized mobile h-[80vh] and z-index 150 for layer parity.
 */
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent 
        ...
        className={cn(
          "bg-zinc-950/98 backdrop-blur-3xl border-white/5 p-0 overflow-hidden shadow-3xl",
        ...
        <div className="flex flex-col h-full relative z-[150]">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 opacity-30 italic">
                  ...
                  <span className="text-[7.5px] font-black uppercase tracking-[0.4em]">Signal_Ledger_v16.68</span>
                </div>
          ...
          >
             <div className="flex items-center gap-2 opacity-20">
                ...
                <span className="text-[7px] font-black uppercase tracking-[0.4em] italic">Synchronized_v16.68</span>
             </div>
          </div>
        </div>
      </SheetContent>
