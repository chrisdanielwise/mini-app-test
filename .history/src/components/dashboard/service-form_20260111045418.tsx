...
/**
 * 🛰️ ASSET PROVISIONING INTERFACE (Apex Tier)
...
export function ServiceForm({ merchantId }: { merchantId: string }) {
  ...
  return (
    <form action={formAction} className="space-y-6 md:space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000 min-w-0">
        ...
        <div className="flex items-center justify-between mb-6 md:mb-8 relative z-10">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="space-y-0.5 md:space-y-1 min-w-0">
              ...
              <p className="text-lg md:text-xl font-black uppercase italic tracking-tighter truncate">
        ...
        <div className="grid gap-6 md:gap-8 relative z-10">
          <div className="space-y-2 md:space-y-3">
            ...
            <Input 
              ...
              required 
              className="h-12 md:h-14 rounded-xl md:rounded-2xl border-border/40 bg-muted/10 px-4 md:px-6 font-black uppercase italic text-xs tracking-tight focus:ring-primary/20 transition-all shadow-inner" 
            />
          </div>
          ...
          <div className="space-y-2 md:space-y-3">
            ...
            <Textarea 
              ...
              className="rounded-xl md:rounded-[1.5rem] min-h-[100px] md:min-h-[120px] border-border/40 bg-muted/10 p-4 md:p-6 text-[10px] md:text-[11px] font-medium leading-relaxed resize-none focus:ring-primary/20 shadow-inner" 
            />
          </div>
            ...
            <div className="space-y-2 md:space-y-3">
              ...
              <div className="relative group">
                ...
                <Input 
                  name="categoryTag" 
                  placeholder="FOREX" 
                  className="h-12 md:h-14 pl-12 rounded-xl md:rounded-2xl border-border/40 bg-muted/10 font-black uppercase text-[9px] md:text-[10px] tracking-[0.2em] shadow-inner" 
                />
              </div>
            </div>
            <div className="space-y-2 md:space-y-3">
        ...
        <div className="grid gap-6 md:gap-8 relative z-10">
          <div className="space-y-2 md:space-y-3">
            ...
            <Input 
              ...
              required 
              className="h-12 md:h-14 rounded-xl md:rounded-2xl border-border/40 bg-muted/10 px-4 md:px-6 font-black uppercase text-[10px] md:text-xs tracking-widest shadow-inner" 
            />
          </div>
            ...
            <div className="space-y-2 md:space-y-3">
              ...
              <div className="relative group">
                ...
                <Input 
                  ...
                  placeholder="99.00" 
                  required 
                  className="h-12 md:h-14 pl-10 rounded-xl md:rounded-2xl border-border/40 bg-muted/10 font-black italic text-sm shadow-inner" 
                />
              </div>
            </div>
            <div className="space-y-2 md:space-y-3">
              ...
              <select 
                name="interval" 
                className="w-full h-12 md:h-14 rounded-xl md:rounded-2xl border border-border/40 bg-muted/10 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] outline-none focus:ring-2 focus:ring-emerald-500/20 appearance-none cursor-pointer shadow-inner"
              >
      ...
      {state?.error && (
        <div className="p-4 md:p-6 rounded-xl md:rounded-[1.5rem] bg-rose-500/5 border border-rose-500/20 animate-in shake-200">
           <p className="text-[9px] md:text-[10px] font-black text-rose-500 uppercase tracking-widest text-center italic">
