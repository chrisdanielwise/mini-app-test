...
/**
 * 💹 REVENUE TELEMETRY NODE
 * Logic: Synchronized with Theme Flavors (Amber for Staff, Emerald for Merchants).
 * Fixed: Adaptive gradient mapping for flavor-based visual telemetry.
 */
export function RevenueChart({ data, theme }: ChartProps) {
  ...
  const strokeColor = isStaff ? "#f59e0b" : "#10b981";
  const stopColor = isStaff ? "#f59e0b" : "#10b981";
