 ...
 * Integration: Merged Legacy Logic with Hardened 2026 Viewport.
 */
export function DashboardTopNav({ context }: { context: any }) {
  ...
  return (
    ...
    >
      ...
      {isMobile && (
        <div className="flex flex-col items-center leading-none absolute left-1/2 -translate-x-1/2 mt-[2px]">
          <span className="text-[6px] font-black uppercase tracking-[0.4em] opacity-20 italic">Status</span>
          <div className="flex items-center gap-1.5 mt-0.5">
            <div className={cn("size-1 rounded-full animate-pulse", themeAmber ? "bg-amber-500" : "bg-primary")} />
            <span className="text-[8px] font-black uppercase tracking-tighter text-foreground italic uppercase">Active</span>
          </div>
        </div>
      )}
