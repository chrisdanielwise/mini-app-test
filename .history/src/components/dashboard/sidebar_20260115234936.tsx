...
import { 
  ...
  ShieldCheck // ✅ FIXED: Imported missing ShieldCheck icon
} from "lucide-react";
...
/**
 * 🛰️ TACTICAL_SIDEBAR (Institutional Apex v2026.1.15)
 * Strategy: High-density, low-profile navigation.
 * Fix: Standardized to 240px width to resolve layout distortion.
 */
