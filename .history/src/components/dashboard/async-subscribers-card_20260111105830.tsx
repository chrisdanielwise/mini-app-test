...
import { AlertCircle, Loader2, Users, TicketCheck, Terminal, Zap, Activity } from "lucide-react";
          ...
          <div className="flex flex-row items-center justify-between mb-8 px-1 md:px-2 relative z-10">
            <div className="space-y-1.5">
              <div className="flex items-center gap-2 italic opacity-40">
                ...
                <h3 className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em]">Network Expansion</h3>
              </div>
