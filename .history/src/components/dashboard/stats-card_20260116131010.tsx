 ...
 * Fix: Reduced height (h-200) and high-density padding (p-6) prevents blowout.
 */
const StatsCardComponent = ({
  ...
  if (!isReady) return (
    <div className="h-[200px] rounded-2xl bg-card/10 animate-pulse border border-white/5" />
  );
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "rounded-2xl md:rounded-3xl border backdrop-blur-3xl shadow-2xl",
      ...
      <div className={cn("relative z-10 w-full leading-none", isMobile ? "p-5" : "p-6")}>
        <div className="flex items-center justify-between mb-6">
          <div className="space-y-1.5 min-w-0">
             ...
             <span className={cn(
               "text-[6.5px] font-black uppercase tracking-widest opacity-10 group-hover:opacity-40",
          ...
          <div className={cn(
            "size-9 md:size-10 shrink-0 rounded-lg flex items-center justify-center border transition-all",
        ...
        <div className="flex flex-col gap-3 min-w-0">
          ...
          {change !== undefined && (
            <div className="flex items-center gap-3">
              <div
                className={cn(
                  "flex items-center rounded-md px-2 py-0.5 text-[7px] font-black uppercase tracking-[0.1em] border italic",
