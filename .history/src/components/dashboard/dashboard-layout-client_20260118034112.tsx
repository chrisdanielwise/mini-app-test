...
/**
 * 🛰️ DASHBOARD_LAYOUT_CLIENT (Institutional v16.16.86)
 * Strategy: Viewport-Locked Shell & Tactical Identity Orchestration.
 * Mission: Coordinate HUD, Admin Tunneling, and Financial Telemetry.
 */
  ...
  return (
    ...
    <div className="flex flex-col h-[100dvh] w-full bg-black overflow-hidden relative selection:bg-primary/30">
      ...
      <header className={cn(
        ...
        impersonationData ? "pt-10" : "pt-0" // 📐 Clearance for Swap Banner
      )}>
        <NavGuard 
