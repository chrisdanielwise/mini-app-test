...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      {/* 🌫️ VAPOUR DEPTH: Pinned background to eliminate "Bogus" jitter */}
      ...
      <main 
        ...
        style={{
          paddingTop: `calc(${safeArea.top}px + 1.25rem)`,
 ...
 * Strategy: Low-profile typography to maximize data visibility.
 */
    ...
    <div className={cn(
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2.5 opacity-20 mb-1.5 italic">
          ...
          <span className="text-[7px] font-black uppercase tracking-[0.5em]">Mesh_Ingress_v16.31</span>
        </div>
