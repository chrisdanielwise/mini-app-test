 ...
 * Fix: Included SheetHeader & SheetTitle to resolve Radix accessibility error.
        ...
        {isMobile ? (
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-[280px] p-0 bg-zinc-950 border-r border-white/5">
              ...
              {/* 🛡️ ACCESSIBILITY FIX: Radix requires a Title inside Dialog/Sheet Content */}
              <SheetHeader className="sr-only">
                <SheetTitle>Terminal_Navigation</SheetTitle>
              </SheetHeader>

              {/* Technical branding inside the drawer to provide context */}
              <div className="px-6 py-5 border-b border-white/5 bg-white/[0.01]">
                <div className="flex items-center gap-2 opacity-40 italic">
                  ...
                  <span className="text-[8px] font-black uppercase tracking-[0.4em]">Navigation_Mesh</span>
                </div>
              </div>
