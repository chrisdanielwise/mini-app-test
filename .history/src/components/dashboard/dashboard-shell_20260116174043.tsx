 ...
 * Fix: Physically displaces the "Merchant Terminal" block to prevent status bar overlap.
 */
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
     ...
     * Locked to absolute physical screen edges using svh units.
     */
    <div
      className={cn(
    ...
    >
      ...
      {/* This pushes Layer 1 BELOW the Telegram UI */}
      <div 
      ...
      {/* 🛰️ LAYER 3: STATIONARY_HUD_NAV
          Stationary at the hardware bottom above OS indicators. */}
      <nav 
      ...
      >
        <div className="h-16 flex items-center justify-around px-2">
           {/* Navigation content anchored here */}
        </div>
      </nav>
    </div>
  );
