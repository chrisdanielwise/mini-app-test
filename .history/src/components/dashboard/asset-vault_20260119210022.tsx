  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn("grid gap-8", isMobile ? "grid-cols-1" : "grid-cols-2")}
        >
          {/* Input Cluster */}
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        {Icon && (
          <Icon className="absolute left-4 top-1/2 -translate-y-1/2 size-3.5 text-primary/20" />
        )}
        <input
          value={value}
    ...
    >
      <div className="relative z-10 space-y-2">
        ...
        <div className="flex items-baseline gap-1.5 leading-none">
          ...
          <span className="text-[8px] font-black opacity-10 uppercase tracking-widest italic">
            USDT
          </span>
        </div>
      </div>
