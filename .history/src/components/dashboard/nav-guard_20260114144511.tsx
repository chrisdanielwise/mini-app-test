...
/**
 * 🛰️ GLOBAL NAV GUARD (Institutional v16.1.0)
 * Logic: Synchronized with Universal Identity, Heartbeat, and Emergency Broadcasts.
 * Feature: Top-level Emergency Banner integration.
 */
export function NavGuard({
  heartbeatStatus,
  systemConfig, // 🚀 Now passed as a prop from LayoutClient
}: {
  ...
  return (
    <div className="sticky top-0 z-50 w-full transition-all duration-500">
      {/* 🚀 EMERGENCY BROADCAST: Anchored to the very top */}
      ...
      <nav
        className={cn(
          "w-full backdrop-blur-2xl border-b transition-all duration-500 animate-in slide-in-from-top-4",
          isStaffFlavor
