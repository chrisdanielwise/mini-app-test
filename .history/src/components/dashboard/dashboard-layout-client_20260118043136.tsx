...
/**
 * 🛰️ DASHBOARD_LAYOUT_CLIENT (Institutional v16.16.89)
    ...
    <div className="flex flex-col h-[100dvh] w-full bg-black overflow-hidden relative selection:bg-primary/30">
      ...
      {mounted && (
        <SettlementRequestDrawer 
          ...
          balance={4250.75} // This should be hydrated from your balance context
        />
      )}
      ...
      >
        <div className="relative min-h-full w-full">
          {!mounted || !isReady ? (
            ...
            >
              {/* Note: You can pass setIsSettlementOpen via Context if needed */}
              {children}
            </div>
          )}
        </div>
