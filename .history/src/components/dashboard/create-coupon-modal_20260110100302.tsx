...
import { createCouponAction } from "@/src/lib/actions/coupon.actions";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
import { Ticket, Loader2, Zap, ShieldCheck, RefreshCw, Terminal, Layers } from "lucide-react";
          ...
          <div className="p-10 space-y-10">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <DialogDescription className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground mt-1 opacity-60">
                    Provisioning new discount node for cluster: {merchantId.slice(0, 8)}
                  </DialogDescription>
                </div>
              </div>
            </DialogHeader>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <Label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1 text-primary">Protocol Identity (Code)</Label>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1 text-primary">Reduction (%)</Label>
                  <Input
                ...
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1 text-primary">Usage Cap</Label>
                  <Input
                    name="maxUses"
                    type="number"
              ...
              {/* --- Targeting Matrix --- */}
              <div className="space-y-3">
                <Label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1 text-primary">Target Service Node</Label>
                ...
                <div className="flex items-center gap-2 p-3 rounded-xl bg-primary/5 border border-primary/10">
                   ...
                   <p className="text-[8px] font-black text-muted-foreground uppercase tracking-widest">
                    Vouchers (100% OFF) grant instant VIP access bypassing gateway.
                  </p>
                </div>
              </div>
            </div>
