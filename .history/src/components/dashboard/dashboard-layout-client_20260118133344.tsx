 ...
 * Fix: Synchronized HUD Baseline with Sheet Close trigger.
 */
  ...
  return (
    <header 
      className={cn(
        ...
        // 🛡️ TACTICAL COMPRESSION: h-14 matches your RootLayout global buffer
      ...
      /* 🏁 REDUNDANCY REMOVED: RootLayout already handles safe-area top padding. */
    >
            ...
            <SheetTrigger asChild>
              <Button 
                ...
                className={cn(
                  ...
                  /* 🏁 THE SYNC: Offset matches your Sheet Close button (+24px logic) */
                  "mt-[6px] ml-1"
                )}
              >
