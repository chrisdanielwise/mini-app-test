...
export function AssetVault({
   ...
   */
  /**
 * 🛰️ Fix: Ensure the hook definition supports dual generics <T, P>
 * This allows startWithdrawal to be typed as <any, WithdrawalPayload>
 */
const { execute: startWithdrawal, loading: isSyncing } = 
  useInstitutionalFetch<any, WithdrawalPayload>(
    async (payload) => {
      // ✅ payload is now correctly inferred as WithdrawalPayload
