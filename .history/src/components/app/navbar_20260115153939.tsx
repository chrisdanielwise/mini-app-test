...
/**
 * 🌊 APP_NAVBAR (Institutional Apex v16.16.31)
 * Refactor: Stripped of internal 'fixed' to prevent Stacking Context conflicts.
...
export function AppNavbar() {
  ...
  // 🌊 SCROLL MONITOR: Attached to the main scroll container via the layout
  useEffect(() => {
    // We target the scrollable 'main' element defined in layout.tsx
  ...
  return (
    <nav
      className={cn(
        // 🛡️ LAMINAR STRUCTURE: No 'fixed' or 'absolute' here. 
        // Positioning is inherited from the Layout's <header> anchor.
