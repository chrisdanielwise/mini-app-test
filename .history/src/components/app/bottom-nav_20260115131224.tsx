...
/**
 * 🌊 FLUID BOTTOM NAV (Apex v16.16.29)
 * Priority: Full DeviceState Integration (xs -> xxl, safeArea, viewportWidth).
 * Logic: Hardware-Aware Morphology with Water-Ease Kinetic Ingress.
 */
export function BottomNav() {
   ...
   * Calculating tactical width and height based on the 6-tier system.
   */
  const navMaxWidth = isDesktop ? "max-w-2xl" : isTablet ? "max-w-xl" : "max-w-md";
  ...
  return (
    ...
    >
      ...
      {/* Subsurface Flow Effect (Scales with viewportWidth) */}
            ...
            >
              ...
              <div className={cn(
                ...
                <item.icon className={cn(
                  "transition-all duration-1000 ease-[var(--ease-institutional)]",
