 ...
 * Fix: Tightened 400ms timing and hardened radii prevent layout jitter.
 */
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-[500] flex flex-col gap-3 bg-zinc-950/80 backdrop-blur-3xl shadow-2xl transition-all duration-400",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
        ...
        style={{
          // 🛡️ TACTICAL CLEARANCE: Clamping hardware safe-zones
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-lg p-2 bg-white/5 opacity-20 transition-all hover:opacity-100 active:scale-95 focus:outline-none">
