 ...
 * Fix: Applied safeArea.bottom to prevent overlap with the home indicator.
 */
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <ToastPrimitives.Viewport
      ...
      style={{
        // 🛡️ TACTICAL CLEARANCE: Respecting 2026 mobile hardware boundaries
        paddingBottom: isMobile ? `calc(${safeArea.bottom}px + 6.5rem)` : "1.5rem",
 ...
 * Fix: Added 'warning' variant to resolve TS2322.
 */
  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-3 overflow-hidden rounded-xl border p-4 shadow-2xl transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        // ✅ RESOLVED: Added warning variant for institutional status updates
        warning: "border-amber-500/20 bg-amber-500/5 text-amber-500 backdrop-blur-3xl",
      },
    },
    defaultVariants: {
      variant: "default",
