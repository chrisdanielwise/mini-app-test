      ...
      >
        ...
        */}
        <SheetPrimitive.Close 
          className="absolute right-4 rounded-lg p-2 bg-white/5 opacity-40 hover:opacity-100 transition-all active:scale-95 focus:outline-none outline-8 outline--700"
