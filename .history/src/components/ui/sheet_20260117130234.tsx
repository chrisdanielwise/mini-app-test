  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
          // 🛡️ THE GLOBAL SYNC: Background covers notch, Padding displaces content.
          // Replicates RootLayout logic: height: calc(var(--tg-safe-top, 27px) + 18px)
      ...
      >
        ...
        {/* ✖️ TACTICAL CLOSE: Anchored to match your Global Buffer depth */}
