 ...
 * Fix: Added internal scroll-containment for high-density menu navigation.
 */
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
          // 🛡️ TACTICAL FIX: 100% Hardware Safe-Area integration for notch clearance
          paddingTop: `calc(0.5rem + ${safeArea.top}px)`,
      ...
      >
        ...
        <SheetPrimitive.Close 
          className="absolute right-4 rounded-lg p-2 bg-white/5 opacity-20 transition-all hover:opacity-100 active:scale-95 focus:outline-none"
          style={{ top: `calc(1rem + ${safeArea.top}px * 0.5)` }}
        >
