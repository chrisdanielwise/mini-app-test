 ...
 * Fix: Apex Z-Index (900) ensures absolute isolation.
 */
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
          /* 🏁 GLOBAL BUFFER SYNC: Matches RootLayout +18px offset */
      ...
      >
        ...
        {/* ✖️ TACTICAL CLOSE: PERFECT HORIZONTAL ALIGNMENT 
            Logic: Root Buffer + HUD Line Sync.
            Offset: +26px matches the mt-[6px] nudge in TopNav/NavGuard.
        */}
