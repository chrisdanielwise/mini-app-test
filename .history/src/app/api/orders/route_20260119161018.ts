...
export async function POST(request: NextRequest) {
  try {
    ...
    // ✅ FIX: We now pack shipping and note into the 'metadata' object
    // as defined in our order.service.ts 'createOrder' signature.
...
// GET method remains valid as implemented previously
