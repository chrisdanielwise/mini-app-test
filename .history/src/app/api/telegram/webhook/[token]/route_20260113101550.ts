...
/**
 * 🛰️ TELEGRAM WEBHOOK HANDLER (Institutional v13.9.25)
 * Logic: Role-Based Routing for Staff, Merchants, and Users.
 */
...
export async function POST(
  ...
  try {
     ...
     * Logic: Mirrors the logic from your bot-service for a unified experience.
     */
    if (text.startsWith("/start")) {
      ...
      if (isStaff || isMerchant) {
        ...
        await telegramFetch("sendMessage", botToken, {
          ...
          reply_markup: {
            inline_keyboard: [
              // 🚀 CRITICAL: Points to /dashboard/login to trigger the Handshake Fix
