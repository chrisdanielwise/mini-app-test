...
import { AuthService, getUserFromRequest } from "@/lib/services/auth.service";
...
Check Terminal Logs to approve.
  ...
  try {
    ...
    await telegramBot.sendMessage(process.env.ADMIN_CHAT_ID!, message, { parse_mode: 'Markdown' });
