    ...
    >
      ...
      <body 
        className={cn(
          ...
          "flex flex-col relative overscroll-none"
        )}
        suppressHydrationWarning
      >
        ...
        <TelegramProvider>
          <LayoutProvider>
            ...
            {/* 📢 SYSTEM BROADCAST NODE: Tactical Notifications */}
            <Toaster 
              position="top-center" 
              expand={false} 
              richColors 
              ...
              closeButton
              toastOptions={{
                className: "rounded-2xl border-border/40 bg-card/80 backdrop-blur-xl font-sans font-bold uppercase tracking-widest text-[10px]",
              }}
            />
          </LayoutProvider>
        </TelegramProvider>
