    ...
    <div className="flex flex-col min-h-screen animate-in fade-in duration-700 max-w-5xl mx-auto leading-none">
      ...
      <main className="flex-1 px-5 py-8 space-y-8 pb-32">
        ...
        <section className="space-y-3">
          <h2 className="text-[7.5px] font-black uppercase tracking-[0.3em] text-muted-foreground/20 italic ml-1">
            Tactile_Protocol
          </h2>
            ...
            >
              <div className="flex items-center gap-3.5 relative z-10">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[7.5px] font-black text-muted-foreground/20 uppercase">
                    Tactile_Ingress_Active
                  </p>
                </div>
              </div>
              <Switch
            ...
            <div className="border-b border-white/5 flex items-center justify-between p-4 md:p-5 gap-4">
              <div className="flex items-center gap-3.5 min-w-0">
                ...
                <div className="space-y-1 min-w-0">
                  <p className="text-[6.5px] font-black uppercase tracking-widest text-muted-foreground/20">
                    Node_ID
                  </p>
                  <p className="text-base font-black italic tracking-tight truncate text-foreground/80">
                    @{user?.username || "anon_node"}
                  </p>
                </div>
              </div>
              <Badge
                className={cn(
                  "shrink-0 rounded text-[7px] font-black px-2 py-0.5 border-none",
                  isStaff
        ...
        <div className="pt-4 space-y-4 relative">
          ...
          <div className="rounded-xl bg-white/[0.01] border border-white/5 p-4 md:p-5 flex gap-4 relative overflow-hidden">
            ...
            <p className="text-[8px] font-black text-muted-foreground/30 leading-relaxed uppercase tracking-widest italic">
              Hardware settings are node-specific. Global identity revocation is
              managed via the institutional hub.
            </p>
          </div>
        </div>
      </main>
