          ...
          <div className="rounded-[2rem] md:rounded-[3rem] border border-border/40 bg-card/40 overflow-hidden shadow-xl">
            ...
            <div className="p-6 md:p-8 border-b border-border/10 flex items-center justify-between gap-4">
               <div className="flex items-center gap-4 min-w-0">
                  ...
                  <div className="space-y-0.5 min-w-0">
                     <p className="text-[7px] md:text-[8px] font-black uppercase tracking-widest text-muted-foreground opacity-60">User Handle</p>
                     <p className="text-xs md:text-sm font-black italic tracking-tight truncate">@{user?.username || "unlinked_node"}</p>
                  </div>
               </div>
               <Badge variant="outline" className="shrink-0 rounded-md bg-emerald-500/5 text-emerald-500 border-emerald-500/20 text-[7px] md:text-[8px] font-black tracking-widest px-2 py-0.5">
                 VERIFIED
               </Badge>
            </div>
            ...
            <div className="p-6 md:p-8 flex items-center justify-between group cursor-default transition-colors hover:bg-muted/5">
               <div className="flex items-center gap-4 min-w-0">
                  ...
                  <div className="space-y-0.5 min-w-0">
                     <p className="text-[7px] md:text-[8px] font-black uppercase tracking-widest text-muted-foreground opacity-60">Session Protocol</p>
                     <p className="text-xs md:text-sm font-black italic tracking-tight truncate">TELEGRAM_OAUTH_v2</p>
                  </div>
               </div>
        ...
        <div className="pt-4 md:pt-8 space-y-6">
           ...
           <div className="rounded-2xl md:rounded-3xl bg-muted/10 border border-border/40 p-5 md:p-6 flex gap-4 shadow-inner">
              ...
              <p className="text-[8px] md:text-[9px] font-bold text-muted-foreground leading-relaxed uppercase tracking-widest opacity-60">
                Identity settings are synchronized across all signal nodes. 
                Full revocation must be performed via the <span className="text-foreground font-black">Official Bot Node</span>.
              </p>
           </div>
        </div>
      </div>
