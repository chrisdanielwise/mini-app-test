...
import { 
  Shield, Zap, ShieldCheck, Terminal, Activity, 
...
export default function ServiceDetailPage({
  ...
  /** * 🛡️ AUTH INGRESS: Corrected destructuring
   * Removed 'auth' property as useInstitutionalAuth returns flat properties.
   */
  ...
  /** * 🛰️ CHECKOUT ENGINE: TS-Safe Invoice Handshake
   */
  const { execute: startCheckout, loading: isSubmitting } = useInstitutionalFetch(
    ...
    },
    {
      onSuccess: (data: { invoiceUrl: string }) => {
        // 🏁 TS FIX: Cast to any to bypass missing property definitions in Telegram types
