...
export default function ServiceDetailPage({
  ...
  // ✅ FIX: Next.js 15 async params resolution
  ...
  // ✅ FIX: Explicit interface for Service aggregation
  ...
  // ✅ FIX: TS2345 - Standardized manual fetch execution
  ...
  return (
    <div className="flex flex-col min-h-screen animate-in fade-in duration-700 leading-none bg-black text-foreground">
      ...
      <main className="flex-1 px-5 py-8 space-y-10 pb-40 overflow-y-auto custom-scrollbar">
