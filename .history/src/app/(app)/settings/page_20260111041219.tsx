            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 relative z-10">
              ...
              <div className="flex flex-col items-center sm:items-start text-center sm:text-left min-w-0">
                ...
                <div className="mt-4 flex flex-wrap justify-center sm:justify-start gap-2">
                  <Badge
                    variant="outline"
                    className="bg-primary/5 text-primary border-primary/20 text-[8px] md:text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-lg"
                  >
                    {user?.role || "USER"}
                  </Badge>
                  {user?.merchantId && (
                    <Badge
                      variant="outline"
                      className="bg-emerald-500/5 text-emerald-500 border-emerald-500/20 text-[8px] md:text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-lg"
                    >
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-col gap-3">
            <SettingItem
              ...
              sublabel="First Name, Last Name, Bio"
            />
            <SettingItem
              icon={Shield}
              label="Security & Sessions"
              sublabel="JWT Node Management"
            />
            <SettingItem
              icon={Bell}
              label="Signal Notifications"
              sublabel="Telegram Alert Frequency"
            />
            <SettingItem
              icon={Globe}
              label="Language"
              sublabel="English (US) / Russian"
            />
          </div>
        </section>
