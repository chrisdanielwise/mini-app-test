...
// ✅ FIXED: Using strictly typed Prisma Enums for comparison
 ...
 * Design: High-density rows with hardware-aware padding.
 */
export default function HistoryPage() {
   ...
   * Logic: Map Prisma Enums to tactical UI styles.
   */
  const getStatusConfig = (status: PaymentStatus) => {
    // ✅ FIX: Strict Enum comparison to resolve TS2367
    const isPositive = status === PaymentStatus.SUCCESS;
    const isNegative = status === PaymentStatus.FAILED || status === PaymentStatus.REJECTED;
    ...
    <div className="flex flex-col min-h-screen animate-in fade-in duration-700 max-w-5xl mx-auto leading-none">
      ...
      >
        <div className="flex items-center justify-between gap-4">
          ...
          )} onClick={() => { if(isMobile) { impact("light"); } }}>
      ...
      {/* 🚀 LEDGER LIST: Padded for Home Indicator */}
      <main 
