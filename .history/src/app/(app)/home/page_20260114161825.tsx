...
/**
 * 🛰️ HOME TERMINAL (Institutional v16.16.0)
 * Logic: Synchronized with Universal Login & Live Emergency Broadcasts.
 */
export default function HomePage() {
  ...
  // 🛡️ 1. SOFT AUTH & BROADCAST HYDRATION
  useEffect(() => {
    if (!mounted) return;
    setTunnelReady(true);
    ...
    <div className="flex flex-col min-h-[100dvh] animate-in fade-in duration-700 max-w-3xl mx-auto text-foreground selection:bg-primary/30">
      ...
      {systemConfig?.broadcastActive && (
        <div className={cn(
          ...
          systemConfig.broadcastLevel === "CRITICAL" ? "bg-rose-600 text-white" : "bg-amber-500 text-black"
        )}>
