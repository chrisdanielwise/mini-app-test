...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Safety Net: If the Telegram SDK hangs for > 5s, 
    // allow the UI to move forward if API data is already here.
  ...
  // We only show the loader if we are TRULY waiting for auth. 
  // If auth.isAuthenticated is already true, we skip the "Ready" check to unstick the page.
