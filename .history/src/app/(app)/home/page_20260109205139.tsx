      ...
      <div className="flex min-h-screen flex-col items-center justify-center gap-6 p-8 text-center bg-background">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            This session is not verified by Telegram. Please launch the app via
            the official bot to sync your ledger.
          </p>
        </div>
      </div>
    );
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 overflow-hidden">
            <h1 className="text-xl font-black tracking-tight truncate uppercase">
              Hi,{" "}
              {user?.first_name || auth.user?.fullName?.split(" ")[0] || "User"}
            </h1>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            {activeSubscriptions.length > 0 && (
              <Badge
                variant="outline"
                className="font-mono text-[10px] border-emerald-500/20 text-emerald-500"
              >
                LATEST
              </Badge>
            )}
          ...
          {subsLoading ? (
            ...
            <div className="space-y-4">
              ...
              {activeSubscriptions.length > 3 && (
                <Link href="/profile">
                  <Button
                    variant="outline"
                    className="w-full rounded-xl border-dashed py-6 font-bold uppercase tracking-widest hover:bg-muted/50"
                  >
            ...
            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border bg-card/30 p-10 text-center">
              ...
              <p className="mb-6 mt-1 text-xs text-muted-foreground">
                Subscribe to a service to unlock premium content.
              </p>
              <Link href="/services">
