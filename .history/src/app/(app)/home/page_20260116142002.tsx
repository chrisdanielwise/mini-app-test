 ...
 * Fix: High-density h-10 buttons and shrunken typography prevent blowout.
 */
export default function HomePage() {
  ...
  const { data: subData, loading: subsLoading } = useInstitutionalFetch<{ subscriptions: any[] }>(
  ...
  return (
    <div className="flex flex-col animate-in fade-in duration-700 max-w-5xl mx-auto leading-none">
      
      {/* 🛡️ BROADCAST: Tactical Slim */}
      {systemConfig?.broadcastActive && (
        <div className={cn(
          "w-full py-2.5 px-4 flex items-center justify-center gap-2 border-b rounded-xl mb-4",
      ...
      <header className="px-5 py-6 md:px-8 md:py-8 rounded-b-2xl md:rounded-b-3xl border-x border-b border-white/5 bg-zinc-950/40 backdrop-blur-xl shadow-2xl relative overflow-hidden">
      ...
      <main className="py-6 md:py-8 space-y-8 px-5 md:px-8">
        ...
        {/* --- DYNAMIC CLUSTERS: Independent Volume --- */}
      ...
      <footer className="mt-auto flex flex-col items-center gap-3 py-10 opacity-10 italic">
