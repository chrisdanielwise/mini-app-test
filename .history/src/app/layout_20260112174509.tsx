...
import { LayoutProvider } from '@/providers/LayoutProvider' // 🛡️ Path Synchronized
...
// 📱 VIEWPORT CONFIG: Mini App Optimization
...
/**
 * 🏛️ ROOT LAYOUT (Institutional v9.6.0)
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html 
      lang="en" 
      // 🛡️ HYDRATION BUNKER: Essential for Telegram WebApp environment
