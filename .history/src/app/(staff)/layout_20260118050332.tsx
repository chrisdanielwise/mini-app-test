 ...
 * Mission: Orchestrate L80+ personnel oversight with hardened geometry.
 */
export default async function StaffRootLayout({
   ...
   * Hardened: Only permits high-clearance node access.
   */
  const AUTHORIZED_ROLES = ["super_admin", "platform_manager", "platform_support", "amber"];
      ...
      <TelegramProvider>
        <LayoutProvider>
          ...
          <div className="flex h-[100dvh] w-full overflow-hidden bg-black selection:bg-amber-500/30">
            ...
            <div className="shrink-0 h-full hidden lg:block border-r border-white/5 bg-zinc-950/50 backdrop-blur-3xl">
            ...
            <div className="flex flex-col flex-1 min-w-0 h-full relative overflow-hidden">
              ...
              <div className="shrink-0 w-full z-[60]">
            ...
            <div className="fixed inset-0 pointer-events-none z-0 opacity-10">
               <div className="absolute top-0 right-0 size-[500px] bg-amber-500/10 rounded-full blur-[140px]" />
               <div className="absolute bottom-0 left-0 size-[300px] bg-amber-600/5 rounded-full blur-[120px]" />
            </div>
