...
import { 
  ...
  Globe, ShieldCheck, AlertCircle, Building2, Activity 
} from "lucide-react";
...
/**
 * 🛰️ TICKET_RESOLUTION_CLIENT (Institutional Apex v2026.1.20)
 * Strategy: Stationary HUD & Independent Tactical Scroll.
 * Fix: High-density geometry prevents header cropping and maximizes resolution visibility.
 */
export default function TicketResponseClient({ ticket, isPlatformStaff, role }: any) {
  ...
  return (
    <div className="w-full h-full flex flex-col min-w-0 overflow-hidden text-foreground bg-black">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 px-6">
          <div className="space-y-1.5 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Badge variant="outline" className="rounded-lg text-[7px] font-black uppercase tracking-[0.1em] px-2 py-0.5 border-white/5 bg-white/5 text-muted-foreground/40 italic">
      ...
      {/* --- 🚀 INTERNAL SCROLL VOLUME: Independent Resolution Matrix --- */}
      <div className="flex-1 min-h-0 w-full relative overflow-y-auto custom-scrollbar px-6 py-6 space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className={cn(
              "rounded-[1.8rem] border p-6 backdrop-blur-3xl shadow-2xl space-y-6 transition-all",
              isPlatformStaff ? "bg-amber-500/[0.01] border-amber-500/10" : "bg-white/[0.01] border-white/5"
            )}>
              <div className="flex items-center gap-2.5 text-muted-foreground/20 opacity-40">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className={cn(
                    "size-10 md:size-12 shrink-0 rounded-xl flex items-center justify-center text-lg font-black italic border shadow-inner transition-transform hover:rotate-6",
            ...
            {!isPlatformStaff && (
              <div className="rounded-[1.5rem] border border-amber-500/10 bg-amber-500/5 p-6 space-y-2 shadow-xl animate-pulse">
            ...
            <div className="rounded-[2.2rem] border border-white/5 bg-black/40 backdrop-blur-3xl overflow-hidden shadow-2xl">
              ...
              <div className="p-6 md:p-8 border-b border-white/5 bg-white/[0.01]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-5 rounded-2xl bg-white/[0.01] border border-white/5 italic text-[11px] md:text-xs text-foreground/50 leading-relaxed shadow-inner">
                  ...
                  <>
                    ...
                    <div className="space-y-3">
                      <Textarea 
                        ...
                        className="min-h-[160px] rounded-[1.5rem] border-white/5 bg-white/5 p-6 font-bold text-xs leading-relaxed focus:ring-primary/10 transition-all resize-none shadow-inner text-foreground placeholder:opacity-10"
                      />
