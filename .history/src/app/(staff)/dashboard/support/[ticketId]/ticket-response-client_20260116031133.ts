...
/**
 * 🛰️ TICKET_RESOLUTION_CLIENT (v16.2.8)
 * Strategy: Absolute Bracket Integrity with Role-based Chroma.
 */
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="rounded-[2.8rem] border border-white/5 bg-black/40 backdrop-blur-3xl overflow-hidden shadow-2xl">
                  ...
                  <div className="pt-4">
                    <Button 
                      ...
                      className={cn(
                        ...
                        isPlatformStaff ? "bg-amber-500 text-black hover:bg-amber-400" : "bg-primary text-primary-foreground hover:scale-[1.01]"
                      )}
                    >
            ...
            </div> {/* End of Input Area div */}
          </div> {/* End of Resolution Card div */}
        </div> {/* End of Right Column (lg:col-span-2) div */}
      </div> {/* End of Main Grid div */}
