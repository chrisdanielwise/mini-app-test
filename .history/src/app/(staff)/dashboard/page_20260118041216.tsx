...
// 🏗️ Institutional UI & Shell Nodes (REINTEGRATED)
  ...
  return (
    <div className="w-full h-full flex flex-col min-w-0 overflow-hidden text-foreground bg-black">
      ...
      <div className="shrink-0 z-30 bg-black/40 backdrop-blur-xl border-b border-white/5 pb-4 pt-2">
        <div className="px-6">
          {/* Reintegrated: DashboardHeader Handles Title/Subtitle logic */}
          <DashboardHeader
          ...
          <div className="flex items-center gap-3 mt-3">
            ...
            <div className="flex items-center gap-2 opacity-30">
              ...
              <p className="text-[7px] font-black uppercase tracking-[0.4em] italic">
                Node_ID: {realMerchantId?.slice(0, 8).toUpperCase() || "ROOT_GLOBAL"}
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Reintegrated: StatsCard serves as the wrapper for Async Data */}
          ...
          {/* Reintegrated: Manual StatsCard for Platform Health */}
          <StatsCard 
