      ...
      <div className="rounded-3xl md:rounded-[3rem] border border-border/40 bg-card/40 backdrop-blur-3xl overflow-hidden shadow-2xl">
        <div className="overflow-x-auto scrollbar-hide">
          <Table className="min-w-[900px]">
            {/* --- CORRECTED TABLE HEADER PROTOCOL --- */}
<TableHeader className="bg-muted/30 border-b border-border/10">
  <TableRow className="hover:bg-transparent border-none"> 
    {["Identity Node", "Service // Tier", "Liquidity", "Timestamp", ""].map((head) => (
      <TableHead 
        key={head} 
        className="h-14 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground/60"
      >
        {head}
      </TableHead>
    ))}
