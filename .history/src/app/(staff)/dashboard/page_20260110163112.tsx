...
import {  } from "@/lib/auth/merchant-session";
 ...
 * Centralized node for monitoring revenue, subscribers, and node performance.
 */
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[2.5rem] bg-primary p-6 text-primary-foreground shadow-lg shadow-primary/20">
              ...
              <p className="text-xs font-bold leading-relaxed opacity-90">
                Full-screen immersion active. {session.merchant.companyName} dashboard is live via Ngrok.
              </p>
            </div>
          </div>
        </div>
