...
import { 
  ...
  Terminal, Globe, Tag, Building2, Activity, Cpu 
} from "lucide-react";
...
/**
 * 🛰️ PROMOTION_LEDGER_CLIENT (Institutional Apex v2026.1.20 - HARDENED)
    ...
    <div className="absolute inset-0 flex flex-col min-w-0 overflow-hidden bg-black text-foreground">
      ...
      <div className="flex-1 min-h-0 w-full relative flex flex-col p-3 pb-6">
        <div className={cn(
                ...
                {coupons.length === 0 ? (
                  ...
                  coupons.map((coupon: any) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 border-r border-white/5">
                        <Badge variant="outline" className="rounded-lg text-[7px] font-black uppercase italic tracking-tighter text-muted-foreground/40 bg-white/5 px-2 py-0.5 border-white/5 truncate max-w-[120px]">
          ...
          {/* --- PERFORMANCE PAGINATION HUD: Stationary baseline --- */}
        ...
        {/* 🌫️ MOBILE CLEARANCE: Ensures pagination clears the floating BottomNav */}
        {isMobile && (
          <div 
