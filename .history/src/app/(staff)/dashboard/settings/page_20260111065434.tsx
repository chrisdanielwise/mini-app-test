...
/**
 * 🛰️ SYSTEM CONFIGURATION NODE (Tactical Medium)
        ...
        <div className="flex flex-col gap-3 min-w-fit flex-1">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[9px] md:text-[10px] font-bold text-muted-foreground uppercase tracking-widest mt-2 opacity-40 italic">
              Node Protocol v2.26 // Edge Sync: Optimal
            </p>
          </div>
        </div>

        <div className="hidden sm:block shrink-0">
           <div className="h-10 w-10 md:h-12 md:w-12 rounded-xl border border-primary/20 bg-primary/5 text-primary flex items-center justify-center shadow-inner">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="lg:col-span-2 space-y-6 md:space-y-8">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-2 text-primary/60 border-b border-border/10 pb-3">
              <Bot className="h-4 w-4" />
              <h2 className="text-[10px] font-black uppercase tracking-widest">Signal Automation Protocol</h2>
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="text-[9px] font-black uppercase tracking-widest text-primary/70 ml-1">Bot Identity</Label>
                <div className="relative">
                  <Terminal className="absolute left-4 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground opacity-20" />
                  <Input 
                    className="h-11 rounded-xl border-border/40 bg-muted/10 pl-11 font-black text-[10px] uppercase tracking-widest text-primary" 
                    placeholder="@SIGNAL_BOT" 
                  />
                </div>
              </div>
              <div className="space-y-2">
                <Label className="text-[9px] font-black uppercase tracking-widest text-primary/70 ml-1">Secure API Handshake</Label>
                <div className="relative">
            ...
            {/* Webhook Logic Block */}
            <div className="group flex items-center justify-between p-5 md:p-6 rounded-2xl bg-card/40 border border-border/40 backdrop-blur-3xl transition-all hover:border-primary/20 gap-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <div className="h-1 w-1 rounded-full bg-primary animate-pulse" />
                  <p className="text-xs font-black uppercase italic tracking-tight">External Ingress</p>
                </div>
                <p className="text-[8px] font-bold text-muted-foreground uppercase leading-relaxed tracking-widest opacity-40">
                  Allow protocol injection from external cloud nodes.
                </p>
              </div>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between p-5 md:p-6 rounded-2xl bg-card/40 border border-border/40 backdrop-blur-2xl hover:bg-muted/10 transition-colors">
                <div className="space-y-1">
                  <p className="text-xs font-black uppercase italic tracking-tight leading-none">Command Mode</p>
                  <select 
                    value={navMode}
                    onChange={(e) => setNavMode(e.target.value as any)}
                    className="bg-transparent text-[8px] font-black uppercase tracking-widest text-primary outline-none cursor-pointer"
                  >
                    <option value="SIDEBAR">Sidebar</option>
                    <option value="TOPBAR">Strip</option>
                    <option value="BOTTOM">Float</option>
                  </select>
                </div>
        ...
        <div className="space-y-6">
          <div className="rounded-2xl bg-card/40 border border-border/40 p-6 md:p-8 backdrop-blur-3xl shadow-xl relative overflow-hidden group">
            ...
            <h3 className="text-[10px] font-black uppercase tracking-widest text-primary/60 mb-6">Security Hub</h3>
            <ul className="space-y-4 relative z-10">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-[9px] font-black uppercase tracking-widest text-foreground/60">Wallet Lock: Active</span>
              </li>
            </ul>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-2 opacity-20 group">
               ...
               <p className="text-[7px] font-black uppercase tracking-[0.4em] italic group-hover:opacity-100 transition-opacity">Close System Node</p>
            </div>
            <Link href="/dashboard">
              <Button 
                variant="outline" 
