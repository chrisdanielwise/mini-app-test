...
/**
 * 🛰️ SETTINGS_PAGE (Institutional Apex v2026.1.20 - HARDENED)
 * Strategy: Viewport-Locked Chassis & Hardware Ingress.
 * Fix: Stationed HUD + Internal Tactical Scroll + border-r grid lines.
 */
        ...
        <div className={cn(
          ...
          <div className="lg:col-span-2 space-y-6">
            <section className="space-y-4">
              ...
              {/* Session Table (Internal Table Engine) */}
              <div className="pt-2">
            ...
            <section className="space-y-4">
              ...
              <div className="flex items-center justify-between p-6 rounded-2xl bg-black/40 border border-white/5 hover:bg-white/[0.02] transition-all group">
                  <div className="space-y-1 leading-none">
                    <p className="text-sm font-black uppercase italic tracking-tighter text-foreground group-hover:text-primary transition-colors">Ultra-Wide Flow</p>
                    <p className="text-[7px] font-black uppercase tracking-[0.2em] text-muted-foreground/20">1920PX_MESH_SYNC</p>
                  </div>
                  <Switch checked={isFullSize} onCheckedChange={toggleFullSize} className="scale-75 data-[state=checked]:bg-emerald-500 shadow-emerald-500/10" />
              </div>
            </section>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col items-center gap-3 py-6 opacity-10 italic">
               ...
               <p className="text-[7px] font-black uppercase tracking-[0.5em] leading-none">Mesh_Processing // Node: {flavor}</p>
            </div>
          </div>
        </div>

        {/* 🌫️ MOBILE CLEARANCE: Ensures nodes clear the floating BottomNav */}
        {isMobile && (
          <div 
