...
export function LoginContent() {
  ...
  /**
   * 🤖 3. TELEGRAM "MODAL-STYLE" INITIALIZATION
   * Architecture: Opens the link in a centered, standalone window.
   */
 /**
 * 🤖 3. TELEGRAM "MODAL-STYLE" INITIALIZATION
 * Logic: Must be synchronous to bypass browser pop-up blockers.
 */
const handleTelegramLogin = () => {
  ...
  // 1. 🚀 IMMEDIATE WINDOW ACTIVATION (No setTimeout)
  // This preserves the "User Gesture" so the browser allows a resized window.
  const width = 550;
  const height = 750;
  ...
  // 3. 🛰️ UPDATE STATE AFTER WINDOW IS OPEN
  setStatus("SYNCING");
  ...
  // 4. 🕵️ WATCHDOG: Reset state if window is closed manually
