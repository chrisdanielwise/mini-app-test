...
function LoginContent() {
      ...
      const performHandshake = async () => {
        ...
        try {
          ...
          if (res.ok && result.success) {
            toast.success("Identity Verified. Anchoring Session...", {
              id: toastId,
            });
  ...
  const handleTelegramLogin = () => {
    ...
    setIsLoading(true);
    hapticFeedback?.("medium"); // If in a hybrid container

    // Use a temporary anchor to prevent popup blockers on some mobile browsers
    const telegramUrl = `https://t.me/${botUsername}?start=terminal_access`;

    // Tactical delay for haptic/loading feel
    setTimeout(() => {
