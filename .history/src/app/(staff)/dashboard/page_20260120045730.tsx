...
function StatsCardSkeleton() { return <div className="min-h-[140px] rounded-[1.8rem] bg-white/[0.01] border border-white/5 animate-pulse" />; }
function FeedSkeleton() { return <div className="h-[400px] rounded-[2.5rem] bg-white/[0.01] animate-pulse border border-white/5" />; }