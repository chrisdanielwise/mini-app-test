...
// IMPORTANT: Use the refined Header component to stop mobile cropping
 ...
 * Fixed: Removed internal Shell wrapping to eliminate the "Double Sidebar".
 * Optimized: Uses Parallel Streaming with Suspense boundaries for high performance.
 */
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      {/* --- Apex Header --- 
          Resolved: Uses the clamp-responsive header to stop mobile cropping.
      */}
      <DashboardHeader 
