...
import { 
  User, ShieldCheck, Key, Terminal, Fingerprint, 
  Lock, Globe, Building2, Activity, Cpu, Save
} from "lucide-react";
...
/**
 * 🛰️ IDENTITY_TERMINAL (Institutional Apex v2026.1.20 - HARDENED)
  ...
  return (
    ...
    <div className="absolute inset-0 flex flex-col min-w-0 overflow-hidden bg-black text-foreground">
      ...
      >
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 px-6">
          ...
          <div className="shrink-0 scale-90 origin-bottom-right">
            ...
            >
              <Save className="mr-2 size-3.5" /> Deploy_Changes
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 min-h-0 w-full relative overflow-y-auto custom-scrollbar overscroll-contain px-4 md:px-6 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <section className={cn(
              ...
              {/* 🏁 ETCHED GRID HEADER */}
              <div className="flex items-center gap-3 border-b border-white/5 p-6 md:px-8 opacity-20">
              ...
              <div className="p-6 md:p-8 grid gap-0 sm:grid-cols-2 rounded-b-[1.8rem] overflow-hidden divide-x divide-y sm:divide-y-0 divide-white/5">
                {/* 🏁 WHITE ETCHED LINES: Forced via border-r/divide-x */}
                <div className="space-y-2 p-4 border-r border-white/5">
            ...
            {!isPlatformStaff && (
              <div className="p-6 rounded-[1.5rem] bg-black/40 border border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl divide-x divide-white/5">
                ...
                <div className="px-6 text-right opacity-10 italic hidden sm:block border-l border-white/5">
          ...
          <div className="space-y-6">
            <section className={cn(
              "rounded-[1.8rem] border backdrop-blur-3xl shadow-2xl overflow-hidden",
              isPlatformStaff ? "bg-amber-500/[0.01] border-amber-500/10" : "bg-black/40 border-white/5"
            )}>
              <div className="flex items-center gap-3 opacity-20 border-b border-white/5 p-6">
        ...
        {/* 🌫️ MOBILE CLEARANCE: Ensures profile bottom signal clears the BottomNav */}
        {isMobile && (
          <div 
        ...
        <div className="flex items-center justify-center gap-4 opacity-10 pt-4 pb-4">
           ...
           <p className="text-[7px] font-black uppercase tracking-[0.5em] italic">
             Identity Sync Stable // Node: {flavor}
           </p>
        </div>
      </div>
    </div>
