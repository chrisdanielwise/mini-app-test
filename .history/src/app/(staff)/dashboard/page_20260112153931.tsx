      ...
      <div className="border-b border-border/40 pb-6">
        ...
        <div className="flex items-center gap-2 mt-2 opacity-30">
          ...
          <p className="text-[8px] font-black uppercase tracking-[0.3em] italic">
            ...
            {isPlatformStaff
              ? "GLOBAL_CORE"
              : session.config.companyName || "CLUSTER_NODE"}{" "}
            // {role}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        */}
        <Suspense fallback={<StatsCard />}>
          <AsyncRevenueCard
            merchantId={isPlatformStaff ? undefined : merchantId}
          />
        </Suspense>
          ...
          {isPlatformStaff && (
            <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-6 shadow-lg">
              ...
              <Link
                ...
                className="block w-full py-3 px-4 bg-amber-500 text-black text-center text-[10px] font-black uppercase tracking-widest rounded-xl hover:scale-[1.02] transition-transform"
              >
