 ...
 * Logic: Hybrid Identity Ingress with Full Operation Node Restoration.
 */
export default async function DashboardPage() {
  ...
  return (
    <DashboardClientView session={session}>
      {/* 🚀 THE RESERVOIR: Independent Scroll Volume fix */}
      <div className="flex-1 w-full overflow-y-auto custom-scrollbar flex flex-col min-h-0 overscroll-contain">
        ...
        <div className="px-4 md:px-6 py-6 space-y-8 flex-1">
          ...
          {/* 📊 TACTICAL STATS LEDGER (Restored StatusNodes) */}
          ...
          {/* --- OPERATIONAL FEED & RAPID COMMANDS (Restored Layout) --- */}
