...
export default async function AnalyticsPage() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-10 md:space-y-14 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-20">
      
      {/* --- COMMAND HUD HEADER: ZERO-CROP PROTOCOL --- */}
      <div className="flex flex-wrap items-end justify-between gap-x-8 gap-y-10 border-b border-border/40 pb-10 px-1">
      ...
      <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4 w-full">
        {/* Metric Node: Revenue */}
        <div className="rounded-[2.5rem] md:rounded-[3rem] border border-primary/20 bg-gradient-to-br from-primary/[0.05] to-transparent p-8 md:p-10 shadow-2xl relative overflow-hidden group min-h-[220px] flex flex-col justify-between">
        ...
        <div className="rounded-[2.5rem] md:rounded-[3rem] border border-border/10 bg-card/40 backdrop-blur-3xl p-8 md:p-10 shadow-xl group min-h-[220px] flex flex-col justify-between">
          <div className="flex justify-between items-start">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 md:gap-10">
        ...
        <div className="xl:col-span-8 rounded-[3rem] border border-border/10 bg-card/40 backdrop-blur-3xl p-8 sm:p-12 md:p-16 shadow-2xl relative overflow-hidden group">
          ...
          <div className="h-[400px] md:h-[550px] w-full relative z-10">
        ...
        <div className="xl:col-span-4 rounded-[3rem] border border-border/10 bg-card/40 backdrop-blur-3xl p-8 sm:p-12 shadow-2xl flex flex-col relative overflow-hidden">
          ...
          <div className="mt-10 p-8 rounded-[2rem] bg-muted/10 border border-border/10 shadow-inner">
