...
/** * 🏗️ ARCHITECTURAL SYNC:
 * Using Namespace Import for service consistency.
 */
...
// 📊 Visualization Components (Client Nodes)
import { RevenueChart } from "@/components/dashboard/analytics-chart";
import { CategoryChart } from "@/components/dashboard/category-chart";
import { cn } from "@/lib/utils";

/**
 * 🛰️ PERFORMANCE ANALYTICS (Staff Tier)
 * Deep-dive node for revenue velocity and asset distribution.
 */
export default async function AnalyticsPage() {
  // 🔐 1. Identity Handshake: Server-side session verification
  const session = await requireMerchantSession();

  // 🏁 2. Data Fetch: Parallel Execution for maximum speed
  ...
  // 📈 3. Revenue Protocol (Timeline Data)
  const chartData = [
  ...
  return (
    <div className="space-y-10 p-4 sm:p-8 pb-32 animate-in fade-in duration-700">
      ...
      {/* --- METRIC GRID (Tier 2 High-Density) --- */}
