      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between border-b border-border/40 pb-8 md:pb-12">
        <div className="space-y-2 md:space-y-4">
          ...
          <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mt-2 flex items-center gap-2 italic">
            ...
            Active Cluster: <span className="text-foreground">{session.config.companyName || "ROOT_NODE"}</span>
          </p>
        </div>
      ...
      <div className="grid gap-4 md:gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-3xl md:rounded-[3rem] border border-primary/20 bg-gradient-to-br from-primary/[0.05] to-transparent p-6 sm:p-8 md:p-10 shadow-2xl group relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-6 md:mb-10">
            <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-primary italic">Gross Capital</p>
          ...
          <div className="space-y-1 md:space-y-2">
            ...
            <div className="flex items-center gap-2 text-emerald-500">
               ...
               <span className="text-[9px] md:text-[10px] font-black uppercase italic tracking-widest">+12.4% VELOCITY</span>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl md:rounded-[3rem] border border-border/40 bg-card/40 backdrop-blur-3xl p-6 sm:p-8 md:p-10 shadow-xl group">
          <div className="flex justify-between items-start mb-6 md:mb-10">
            <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground italic">Subscriber Load</p>
        ...
        <div className="rounded-3xl md:rounded-[3rem] border border-border/40 bg-card/40 backdrop-blur-3xl p-6 sm:p-8 md:p-10 shadow-xl group">
          <div className="flex justify-between items-start mb-6 md:mb-10">
            <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground italic">Support Stress</p>
        ...
        <div className="rounded-3xl md:rounded-[3rem] border border-border/40 bg-card/40 backdrop-blur-3xl p-6 sm:p-8 md:p-10 shadow-xl group">
          <div className="flex justify-between items-start mb-6 md:mb-10">
            <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground italic">System Rating</p>
          ...
          <div className="space-y-1 md:space-y-2">
            <p className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter italic uppercase">
              Staff<span className="text-primary text-xl md:text-2xl">_Tier</span>
            </p>
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 sm:pb-0 scrollbar-hide">
               {["1D", "1W", "1M", "ALL"].map((time) => (
                  <button key={time} className={cn(
                    ...
                    time === "1M" ? "bg-primary text-primary-foreground border-primary shadow-lg" : "bg-muted/30 border-border/40 text-muted-foreground hover:bg-muted/50"
                  )}>
                    {time}
                  </button>
               ))}
        ...
        <div className="rounded-3xl md:rounded-[4rem] border border-border/40 bg-card/40 backdrop-blur-3xl p-6 sm:p-10 md:p-12 shadow-2xl flex flex-col relative overflow-hidden">
          ...
          <div className="mt-8 md:mt-12 p-6 md:p-8 rounded-2xl md:rounded-[2.5rem] bg-muted/10 border border-border/40 backdrop-blur-sm relative z-10">
            <div className="flex items-center gap-3 mb-2 md:mb-3">
               ...
               <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500">Risk Audit Pass</p>
            </div>
