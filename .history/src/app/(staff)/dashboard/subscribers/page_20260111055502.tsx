...
export default async function SubscribersPage() {
  ...
  return (
    <div className="max-w-full overflow-x-hidden space-y-8 md:space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-10">
      ...
      {/* --- COMMAND HUD HEADER --- */}
      <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between px-1">
        <div className="space-y-3">
          ...
          {/* FLUID TEXT: Scales dynamically with viewport */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter uppercase italic leading-[0.9]">
            Subscriber <span className="text-primary">Ledger</span>
          </h1>
          <p className="text-[9px] md:text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] mt-2 opacity-40">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
          <div className="relative flex-1 xl:w-80 group">
            ...
            <Input 
              ...
              className="h-12 md:h-14 w-full pl-12 rounded-2xl border-border/40 bg-card/40 font-black text-[10px] uppercase tracking-[0.2em]"
            />
          </div>
          <div className="flex gap-2 w-full sm:w-auto">
            <Button variant="outline" className="flex-1 sm:flex-none h-12 md:h-14 px-5 rounded-2xl border-border/40 bg-muted/10 text-[10px] font-black uppercase tracking-widest">
              <Filter className="mr-2 h-4 w-4" /> Filter
            </Button>
            <Button className="flex-1 sm:flex-none h-12 md:h-14 px-5 rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-2xl bg-primary text-primary-foreground">
