...
export default async function SubscribersPage() {
  ...
  return (
    <div className="max-w-full overflow-x-hidden space-y-8 md:space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-10">
      /** * 🛰️ COMMAND HUD HEADER (Sync Tier) * Fixed: intrinsic flex-wrap logic
      to prevent horizontal cropping. * Optimized: Adaptive typographic scale
      for zero-bleed rendering. */
      ...
      */}
        ...
        <div className="flex flex-col sm:flex-row items-stretch gap-3 w-full lg:w-auto shrink-0 lg:mt-auto">
          ...
          <div className="flex gap-2 h-11 md:h-13">
            <Button
              variant="outline"
              className="flex-1 lg:flex-none h-full px-4 rounded-2xl border-border/40 bg-muted/10 text-[9px] md:text-[10px] font-black uppercase tracking-widest hover:bg-primary/5 hover:text-primary transition-all"
            >
