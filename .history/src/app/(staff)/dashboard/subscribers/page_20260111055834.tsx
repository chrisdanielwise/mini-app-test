      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between px-2">
        <div className="space-y-4 flex-shrink-0">
          ...
          <div className="space-y-1">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-[-0.05em] uppercase italic leading-[0.85] text-foreground">
              Subscriber <br className="sm:hidden" />
        ...
        {/* Utility Actions Node: Wraps automatically on collision */}
        <div className="flex flex-col sm:flex-row items-stretch gap-3 w-full lg:w-auto">
          <div className="relative flex-1 lg:w-72 xl:w-96 group">
            ...
            <Input
              ...
              className="h-12 md:h-14 w-full pl-12 rounded-2xl border-border/40 bg-card/40 font-black text-[10px] uppercase tracking-[0.2em] focus:ring-primary/20"
            />
          </div>
          ...
          <div className="flex gap-2 h-12 md:h-14">
            <Button
              variant="outline"
              className="flex-1 lg:flex-none h-full px-5 rounded-2xl border-border/40 bg-muted/10 text-[10px] font-black uppercase tracking-widest hover:bg-primary/5 hover:text-primary transition-all"
            >
