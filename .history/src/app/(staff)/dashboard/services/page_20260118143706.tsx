...
/**
 * 🛰️ SERVICE FLEET COMMAND (Institutional v16.1.20 - Hardened)
 * Strategy: Locked Viewport & Flex-Reservoir Ingress.
 * Fix: Forced 'overflow-hidden' on parent and 'min-h-0' on scroll container.
 */
export default async function ServicesPage() {
  ...
  return (
    /* 🏛️ PRIMARY CHASSIS: Locked to 100% height, preventing page-level scrolling */
    <div className="w-full h-full flex flex-col min-w-0 overflow-hidden text-foreground bg-black">
      ...
      <div className="flex-1 min-h-0 w-full relative p-3 pb-6">
        <div className={cn(
          ...
          {/* 🌊 THE SCROLL ENGINE: This is the only part that moves */}
          <div className="flex-1 w-full overflow-auto custom-scrollbar">
            <table className="w-full text-left border-collapse min-w-[900px] table-fixed">
              {/* STICKY THEAD: Stays visible during row scroll */}
