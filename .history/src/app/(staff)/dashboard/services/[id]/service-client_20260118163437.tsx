...
/**
 * 🛰️ TACTICAL_SLIM_LEDGER (v16.9.0 - MINIMALIST GRID)
 * Strategy: High-Density Etched Grid / No Pagination.
 * Fix: Removed baseline pagination HUD to maximize vertical viewport.
 * Fix: Retained forced 'border-r' for high-contrast etched lines.
 */
export default function ServicesClientPage({ 
  ...
  return (
    <div className="absolute inset-0 flex flex-col min-w-0 overflow-hidden bg-black text-foreground">
          ...
          <div className="flex flex-col gap-2 min-w-fit flex-1">
            ...
            <div className="space-y-0.5">
              ...
              <div className="flex items-center gap-x-4 pt-1 opacity-20 italic">
                ...
                <p className="text-[8px] font-black uppercase tracking-widest flex items-center gap-1.5 ml-auto md:ml-0">
                  <Terminal className="h-3 w-3" /> ID: <span className="text-foreground uppercase">{role}</span>
                </p>
              </div>
            </div>
          </div>
      ...
      {/* 🌫️ MOBILE CLEARANCE: Prevents BottomNav overlap with the last row */}
      {isMobile && (
        <div 
