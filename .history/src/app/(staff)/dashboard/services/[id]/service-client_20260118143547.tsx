 ...
 * Fix: Removed 'h-full' on absolute child to prevent height overflow.
 * Fix: Re-implemented flex-col min-h-0 to force internal scrolling.
 */
export default function ServicesClientPage({ 
  ...
  return (
    /* 🏛️ PRIMARY ENTRY: Absolute filling of the Server's flex-1 slot */
    <div className="absolute inset-0 flex flex-col min-w-0 overflow-hidden bg-black text-foreground">
      
      {/* --- 🛡️ FIXED COMMAND HUD: Stationary (shrink-0) --- */}
      ...
      {/* --- 🚀 INTERNAL SCROLL VOLUME: flex-1 + min-h-0 Captures Scroll --- */}
      <div className="flex-1 min-h-0 w-full relative p-3">
        <div className={cn(
          ...
          {/* THE SCROLL ENGINE: Overflow handling */}
