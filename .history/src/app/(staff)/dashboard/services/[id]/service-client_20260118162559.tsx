...
import { Users, Zap, Globe, Layers, Activity, Terminal, Building2 } from "lucide-react";
...
/**
 * 🛰️ TACTICAL_SLIM_LEDGER (Institutional v16.6.2 - RESTORED)
 * Strategy: Stationary HUD + Locked Scroll Reservoir.
 * Fix: Re-implemented flex-col h-full with shrink-0 header to lock table within viewport.
 */
export default function ServicesClientPage({ 
  ...
  return (
    <div className="w-full h-full flex flex-col min-w-0 overflow-hidden bg-black text-foreground">
      ...
      {/* --- 🚀 INTERNAL SCROLL VOLUME: Table is locked inside this flex-1 container --- */}
      <div className="flex-1 min-h-0 w-full relative p-3">
        <div className={cn(
          ...
          {/* THE SCROLL ENGINE: Only this div scrolls */}
