...
/**
 * 🛰️ SERVICE_FLEET_CONFIG_CLIENT (v16.3.5)
 * Strategy: Truncation guards for overflow + Evaluation safety.
 */
export default function ServiceConfigClient({ 
  service, 
  isPlatformStaff = false, // 🛡️ Default prevents evaluation errors
  role = "merchant"        // 🛡️ Default prevents evaluating 'role.toUpperCase'
}: any) {
  ...
  return (
    ...
    >
      {/* --- COMMAND HEADER --- */}
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between border-b border-white/5 pb-8 relative">
        {/* 🛡️ FIX: Added min-w-0 to the flex parent to enable child truncation */}
        <div className="space-y-4 flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-5 min-w-0">
            {/* 🛡️ FIX: Added truncate + max-width to prevent large names from blowing out the screen */}
            <h1 className="text-3xl md:text-5xl font-black tracking-tighter uppercase italic leading-none truncate max-w-[100%] text-foreground">
              {service.name}
            </h1>
            <Badge className={cn(
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-2 opacity-30 italic">
            {isPlatformStaff && (
              <p className="text-[10px] font-black uppercase tracking-widest flex items-center gap-2 text-amber-500">
                ...
                Origin: <span>{service.merchant?.companyName || "PLATFORM"}</span>
              </p>
            )}
          ...
          >
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-black uppercase text-muted-foreground/30 tracking-widest italic leading-none">
            ...
            service.tiers.map((tier: any) => (
              ...
              >
                ...
                <div className="space-y-2 mb-10 min-w-0">
                  ...
                  {/* 🛡️ FIX: Added truncate to tier names */}
