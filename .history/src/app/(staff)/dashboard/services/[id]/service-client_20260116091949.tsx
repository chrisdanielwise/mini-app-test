  ...
  return (
    <div 
      className={cn(
        ...
        // 🛡️ TIGHTENED: Reduced global vertical spacing from space-y-10 to space-y-4
    ...
    >
      {/* --- COMMAND HUD HEADER --- */}
      {/* 🛡️ TIGHTENED: Reduced pb-8 to pb-4 */}
        ...
        <div className="overflow-x-auto scrollbar-hide">
          <table className="w-full text-left border-collapse min-w-[1000px]">
            <thead className="bg-white/[0.02] border-b border-white/5">
              <tr>
                {/* 🛡️ TIGHTENED: Changed px-10 py-4 to px-8 py-3 */}
                <th className="px-8 py-3 text-[9px] font-black uppercase tracking-[0.4em] text-muted-foreground/30 italic">Signal Identity</th>
                {isPlatformStaff && <th className="px-8 py-3 text-[9px] font-black uppercase tracking-[0.4em] text-amber-500/40 italic">Origin Node</th>}
                <th className="px-8 py-3 text-[9px] font-black uppercase tracking-[0.4em] text-muted-foreground/30 italic">Network Load</th>
                <th className="px-8 py-3 text-[9px] font-black uppercase tracking-[0.4em] text-muted-foreground/30 italic">Architecture</th>
                <th className="px-8 py-3 text-[9px] font-black uppercase tracking-[0.4em] text-muted-foreground/30 italic">Status</th>
            ...
            <tbody className="divide-y divide-white/5">
              {initialServices.length === 0 ? (
                ...
                initialServices.map((service: any) => (
                  ...
                  >
                    {/* 🛡️ TIGHTENED: Reduced row padding to py-3 */}
                      ...
                      <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0 max-w-[280px]">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            <p className="text-[7px] font-mono font-bold text-muted-foreground/20 uppercase">
                    ...
                    {isPlatformStaff && (
                      <td className="px-8 py-3">
                        <div className="flex items-center gap-2 text-amber-500/60 font-black uppercase italic text-[9px] tracking-widest leading-none truncate max-w-[150px]">
                    ...
                    <td className="px-8 py-3 text-right">
                      {/* 🛡️ TIGHTENED: Passed compact size prop if ServiceActionWrapper supports it */}
