  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between border-b border-white/5 pb-8">
        {/* 🛡️ FIX: Added min-w-0 to allow truncation within the flex child */}
        <div className="space-y-4 flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-5 min-w-0">
            {/* 🛡️ FIX: Added truncate and constrained max-width to prevent container blowout */}
            <h1 className="text-3xl md:text-5xl font-black tracking-tighter uppercase italic leading-none truncate max-w-[90%] md:max-w-full">
              {service.name}
            </h1>
            <Badge className={cn(
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-2 opacity-30 italic">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest flex items-center gap-2 text-foreground">
              ...
              Node: <span>{service.id.slice(0, 12).toUpperCase()}</span>
            </p>
            <p className="text-[10px] font-black uppercase tracking-widest flex items-center gap-2 text-foreground">
          ...
          {service.tiers.length === 0 ? (
            ...
            service.tiers.map((tier: any) => (
              <div
                ...
                className={cn(
                  "relative group rounded-[3rem] border bg-card/40 p-10 md:p-12 transition-all duration-500 hover:shadow-2xl overflow-hidden",
      ...
      <div className="flex items-center justify-center gap-4 opacity-10 py-16">
        ...
        <p className="text-[9px] font-black uppercase tracking-[0.6em] italic text-center">
