 ...
 * Fixed: Resolves session 'id' undefined crash and aligns with MerchantRole permissions.
 */
export default async function ServicesPage() {
  /**
   * 🔐 IDENTITY HANDSHAKE
   * requireMerchantSession returns { user, merchantId, config }
   * This check ensures UserRole is at least MERCHANT and validates MerchantRole (OWNER/ADMIN).
   */
  const session = await requireMerchantSession();
  
  // ✅ THE FIX: Accessing the flat property 'merchantId' from the hardened session
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-6 mt-6">
            <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] flex items-center gap-2">
              ...
              {/* ✅ FIXED: Accessing companyName via the session config object */}
              ...
              {services.length === 0 ? (
                ...
                services.map((service: any) => (
                  ...
                  >
                    ...
                    {/* Pricing Architecture (Tiers Count) */}
                    <td className="px-10 py-10">
                      <div className="flex flex-col gap-1.5">
                    ...
                    {/* Operational Trigger (Admin/Owner Control) */}
