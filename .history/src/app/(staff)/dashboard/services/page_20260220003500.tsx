...
/**
 * 🛰️ SERVICE FLEET COMMAND (v2026.1.21)
 * Strategy: Viewport-Locked Chassis & Table Reservoir.
 * Fix: Explicit cache-busting and null-safe session ingress for Render builds.
 */
export const dynamic = "force-dynamic";
export const revalidate = 0; // ✅ ADDED: Ensures fresh telemetry on every load
