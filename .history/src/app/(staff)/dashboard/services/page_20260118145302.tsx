...
export default async function ServicesPage() {
  ...
  return (
    /** * 🏛️ THE CHASSIS FIX: 
     * We use h-full + overflow-hidden to lock this page to the DashboardLayout's main area.
     */
    <div className="w-full h-full flex flex-col min-w-0 overflow-hidden text-foreground bg-black">
      
      {/* --- 🛡️ FIXED COMMAND HUD: shrink-0 is mandatory here --- */}
      ...
      {/* --- 🚀 INTERNAL SCROLL VOLUME: flex-1 min-h-0 is the only way to lock the scroll --- */}
      <div className="flex-1 min-h-0 w-full relative p-3 pb-6">
        <div className={cn(
          ...
          {/* 🌊 THE SCROLL ENGINE: Only this div and the table inside it will move */}
          <div className="flex-1 w-full overflow-auto custom-scrollbar">
            <table className="w-full text-left border-collapse min-w-[900px] table-fixed relative">
              {/* STICKY THEAD: Keeps headers visible while scrolling rows */}
