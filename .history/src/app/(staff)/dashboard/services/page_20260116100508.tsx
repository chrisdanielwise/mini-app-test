 ...
 * Strategy: Fixed-layout grid to prevent content-driven overflow.
 * Fix: Added table-fixed and min-w-0 for identity truncation.
 */
    ...
    <div className="max-w-7xl mx-auto space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 pb-10 px-4 text-foreground">
      ...
      <div className={cn(
        ...
        <div className="overflow-x-auto scrollbar-hide">
          {/* 🛡️ FIX: Added table-fixed to lock width to 100% of container */}
          <table className="w-full text-left border-collapse min-w-[1000px] table-fixed">
            <thead className="bg-white/[0.02] border-b border-white/5">
              <tr>
                {/* 🛡️ FIX: Defined column widths to ensure predictable scaling */}
                ...
                services.map((service: any) => (
                  <tr key={service.id} className="hover:bg-white/[0.01] transition-all duration-300 group border-none">
                    <td className="px-10 py-8">
                      {/* 🛡️ FIX: Added min-w-0 to the flex parent to allow text truncation */}
                      <div className="flex items-center gap-6 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0">
                          {/* 🛡️ FIX: Added truncate to prevent long names from expanding the cell */}
