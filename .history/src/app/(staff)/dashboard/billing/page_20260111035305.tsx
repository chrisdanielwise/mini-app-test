  ...
  return (
    <div className="space-y-8 md:space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between border-b border-border/40 pb-8 md:pb-12">
        ...
        <Badge
          variant="outline"
          className="w-fit h-10 md:h-12 border-primary/30 bg-primary/5 px-4 md:px-6 rounded-xl md:rounded-2xl text-[10px] font-black uppercase tracking-widest text-primary shadow-inner"
        >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 md:gap-10">
          ...
          <div className="relative z-10 flex flex-col justify-between h-full space-y-10 md:space-y-12">
            <div className="flex items-start justify-between">
              <div className="space-y-1 md:space-y-3">
                <p className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-60 italic">
                  Current Access Tier
                </p>
            ...
            <div className="grid gap-4 md:gap-6 sm:grid-cols-2">
              {[
                ...
                >
                  ...
                  <span className="text-[10px] md:text-[11px] font-black uppercase tracking-widest text-foreground/80 group-hover/item:text-foreground transition-colors truncate">
                    {feature}
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-8 md:pt-10 border-t border-border/10">
              ...
              <Button
                variant="outline"
                className="h-12 md:h-16 px-8 md:px-10 rounded-xl md:rounded-2xl border-border/40 bg-muted/10 font-black uppercase text-[10px] tracking-widest"
              >
                Audit Invoices
              </Button>
            </div>
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="rounded-3xl md:rounded-[3rem] border border-border/40 bg-card/40 p-6 md:p-10 backdrop-blur-3xl shadow-2xl flex flex-col justify-between gap-10">
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-center gap-3 text-primary">
                <div className="h-8 w-8 rounded-xl bg-primary/10 flex items-center justify-center">
                  <CreditCard className="h-4 w-4" />
                </div>
                <h3 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.3em]">
                  Payment Terminal
                </h3>
              </div>
              ...
              <div className="rounded-2xl md:rounded-3xl border border-border/40 bg-muted/20 p-6 md:p-8 shadow-inner group cursor-pointer hover:border-primary/30 transition-all">
                <p className="text-[8px] font-black text-muted-foreground uppercase tracking-widest mb-3 opacity-40 italic">
                  Verified Visa Node
                </p>
                <div className="flex items-center justify-between">
                  <p className="font-mono text-lg md:text-xl font-black tracking-widest leading-none">
                    •••• 4242
                  </p>
            ...
            <Button
              variant="ghost"
              className="text-primary font-black uppercase italic tracking-[0.2em] text-[10px] p-0 h-auto justify-start hover:bg-transparent hover:text-primary/70 group"
            >
          ...
          <div className="p-6 md:p-8 rounded-2xl md:rounded-[2.5rem] bg-muted/10 border border-border/40 space-y-3 md:space-y-4 shadow-sm">
            ...
            <p className="text-[9px] font-bold text-muted-foreground leading-relaxed uppercase tracking-widest opacity-50">
              All transactions broadcasted via encrypted SSL/TLS channels.
              Billing cycles are strictly 30-day epochs. Unauthorized access
              triggers lockout.
            </p>
          </div>
        </div>
