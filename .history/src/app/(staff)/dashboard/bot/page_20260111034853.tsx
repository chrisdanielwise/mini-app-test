      ...
      <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 border-b border-border/40 pb-12">
        <div className="space-y-3">
          ...
          <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.4em] opacity-40">
            Active Node: {session.merchant.botUsername || "SYSTEM_DEFAULT"} //
        ...
        <div className="flex gap-4">
          <Button
            variant="outline"
            className="h-14 px-8 rounded-2xl border-border/40 bg-muted/10 font-black uppercase text-[10px] tracking-widest"
          >
        ...
        <div className="xl:col-span-2 space-y-10">
          {services.length === 0 ? (
            ...
            services.map((service) => (
              <div
                key={service.id}
                className="group relative overflow-hidden rounded-[3.5rem] border border-border/40 bg-card/40 backdrop-blur-3xl shadow-2xl transition-all hover:border-primary/20"
              >
                <div className="p-10 md:p-14 space-y-10">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <Badge
                      variant="outline"
                      className="rounded-lg bg-emerald-500/5 text-emerald-500 border-emerald-500/20 text-[9px] font-black uppercase tracking-widest px-4 py-2"
                    >
                      INGRESS_ENABLED
                    </Badge>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      <div className="flex-1 bg-zinc-950/50 border border-border/40 rounded-2xl px-6 py-5 font-mono text-xs tracking-tighter text-emerald-500 shadow-inner truncate">
                        https://api.zipha.finance/v1/webhooks/signals/
                        {service.id}
                      </div>
                      <Button
                        variant="ghost"
                        className="rounded-2xl border border-border/40 bg-card h-16 w-16 shrink-0 hover:bg-primary hover:text-white transition-all"
                      >
                  ...
                  <div className="space-y-4 pt-4">
                    ...
                    <pre className="relative group/code bg-zinc-950 p-8 rounded-[2rem] border border-border/40 font-mono text-[11px] overflow-x-auto leading-relaxed text-zinc-400 shadow-2xl">
                      <div className="absolute top-4 right-4 text-[8px] font-black text-zinc-700 tracking-widest">
                        application/json
                      </div>
                      {`{
        ...
        <div className="space-y-10">
          ...
          <div className="rounded-[3rem] bg-primary p-10 text-primary-foreground shadow-2xl shadow-primary/30 relative overflow-hidden group">
            ...
            <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-4">
              Tactical <span className="text-zinc-900/50">Docs</span>
            </h3>
            <p className="text-[11px] font-black uppercase leading-relaxed tracking-widest opacity-80 mb-10">
              Integrate TradingView alerts instantly by mapping your strategy to
              the JSON Manifest above. Paste the endpoint into the "Webhook URL"
              field.
            </p>
          ...
          <div className="rounded-[3rem] border border-border/40 bg-card/40 p-10 backdrop-blur-2xl shadow-xl">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-foreground/70 group-hover:text-amber-500 transition-colors">
                  Rotate Node Secrets
                </span>
              </div>
            </div>
