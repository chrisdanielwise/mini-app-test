...
/**
 * 🛰️ SIGNAL_INGRESS_TERMINAL (Institutional Apex v2026.1.25 - HARDENED)
 * Strategy: Viewport-Locked Chassis & Hardware Ingress.
 * Fix: Stationed HUD + Internal Tactical Scroll + Safe-Area offset.
 */
export default function BotConfigPage({ services: initialServices = [] }: any) {
  ...
  if (!isReady) return (
    <div className="h-full w-full flex flex-col items-center justify-center bg-black gap-4">
      ...
      <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/10">Syncing_Encryption_Node...</p>
    </div>
  );
  ...
  return (
    ...
    <div className="absolute inset-0 flex flex-col min-w-0 overflow-hidden bg-black text-foreground">
      ...
      <div className="flex-1 min-h-0 w-full relative overflow-y-auto custom-scrollbar overscroll-contain px-4 md:px-6 py-6">
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                >
                  <div className="p-6 md:p-8 space-y-6">
                    <div className="flex justify-between items-start gap-4">
                      ...
                      <Badge className="rounded-lg bg-emerald-500/10 text-emerald-500 border-emerald-500/20 text-[7px] font-black uppercase px-2 py-1">
                        ACTIVE
                      </Badge>
                    </div>

                    {/* 🏁 ETCHED GATEWAY ADDRESS */}
                    <div className="space-y-2">
                      <Label className="text-[7px] font-black uppercase tracking-[0.3em] text-muted-foreground/30 italic">Gateway_Endpoint</Label>
                      <div className="flex gap-0 rounded-xl border border-white/5 overflow-hidden bg-black/60 shadow-inner divide-x divide-white/5">
                        <div className="flex-1 px-4 h-11 flex items-center font-mono text-[9px] text-emerald-500/70 truncate italic">
                        ...
                        <Button
                          ...
                          variant="ghost" className="h-11 px-4 shrink-0 hover:bg-emerald-500 hover:text-black transition-colors rounded-none"
                        >
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[1.8rem] border border-white/5 bg-black/40 p-6 backdrop-blur-3xl shadow-xl space-y-6">
              ...
              <div className="space-y-0 rounded-xl border border-white/5 overflow-hidden divide-y divide-white/5 bg-white/[0.01]">
                ...
                >
                  ...
                  <span className="text-[8px] font-black uppercase tracking-widest text-foreground/30 italic">
                    Rotate Secret
                  </span>
                </div>
              </div>
        ...
        {/* 🌫️ MOBILE CLEARANCE: Ensures nodes clear the BottomNav */}
        {isMobile && (
          <div 
