      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between border-b border-border/40 pb-12">
        <div className="space-y-3">
          ...
          <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.4em] mt-4 opacity-40">
            Institution: {session.merchant.companyName} // Edge_Node_Sync: Stable
          </p>
        </div>
          ...
          <div className="relative z-10 flex flex-col justify-between h-full">
            <div className="flex items-center justify-between mb-8">
               <div className="space-y-2">
                  ...
                  <span className="text-[8px] font-black text-muted-foreground uppercase tracking-widest opacity-40">Ready for Immediate Sync</span>
               </div>
            ...
            <p className="text-6xl md:text-7xl font-black text-foreground tracking-tighter italic leading-none">
              <span className="text-emerald-500 text-3xl md:text-4xl align-top mr-1 font-bold italic">$</span>
          ...
          <div className="relative z-10 flex flex-col justify-between h-full">
            <div className="flex items-center justify-between mb-8">
               <div className="space-y-2">
                  ...
                  <span className="text-[8px] font-black text-muted-foreground uppercase tracking-widest opacity-20">Awaiting Clearing Epoch</span>
               </div>
            ...
            <p className="text-6xl md:text-7xl font-black text-muted-foreground/30 tracking-tighter italic leading-none">
              <span className="text-2xl md:text-3xl align-top mr-1 font-bold italic">$</span>
              ...
              {payouts.length === 0 ? (
                ...
                payouts.map((payout: any) => (
                  ...
                  >
                    ...
                    <td className="py-8">
                      <Badge variant="outline" className="rounded-lg bg-muted/10 border-border/40 px-3 py-1 text-[9px] font-black uppercase tracking-widest italic opacity-60">
