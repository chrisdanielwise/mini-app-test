            ...
            <div className="flex flex-col flex-1 min-w-0 overflow-hidden relative">
              ...
              <DashboardLayoutClient userRole={userRole}>
                <main className={cn(
                  ...
                  {/* 🏎️ PAGE INGRESS: Animated content hydration */}
                  <div className="p-6 md:p-10 lg:p-14 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-[cubic-bezier(0.2,0.8,0.2,1)]">
                    {children}
                  </div>
                </main>
