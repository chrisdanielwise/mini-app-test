...
import { TierSelector } from "@/src/components/app/tier-selector";
import { cn } from "@/src/lib/utils";
import { useTelegramContext } from "@/src/components/telegram/telegram-provider"; // ✅ Linked Context

/**
 * 🛰️ MERCHANT REGISTRATION PROTOCOL (Apex Tier)
 * Fixed: Now successfully accesses Telegram Context via the root-level Provider.
 */
export default function RegisterPage() {
  ...
  const { hapticFeedback } = useTelegramContext(); // ✅ Hook into native hardware
  ...
  const handleNextStep = () => {
    hapticFeedback("medium"); // ⚡ Trigger native haptic on step change
    setStep(2);
  };
            ...
            <div className="space-y-10 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-[0.3em] ml-2 text-muted-foreground">
                    Admin Identity
                  </Label>
                  <Input
              ...
              <div className="pt-6 space-y-6">
                ...
                <div className="flex gap-4 px-6 items-start opacity-50">
                  ...
                  <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest leading-relaxed italic">
                    ...
                    <span className="text-primary font-black">Zipha Bot</span>.
                  </p>
                </div>
              </div>
