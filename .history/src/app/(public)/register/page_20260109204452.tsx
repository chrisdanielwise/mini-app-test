    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-background pt-32 pb-24 overflow-hidden relative">
      ...
      <div className="w-full max-w-2xl space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground">
            Step {step} of 2: {step === 1 ? "Select Protocol" : "Cluster Details"}
          </p>
        </div>
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-widest ml-1">Merchant Name</Label>
                  <Input placeholder="John Doe" className="h-14 rounded-2xl bg-background/50 border-border/50 font-bold" />
                </div>
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-widest ml-1">Company / Brand</Label>
                  <Input placeholder="Zipha Signals" className="h-14 rounded-2xl bg-background/50 border-border/50 font-bold" />
                </div>
              </div>

              <div className="space-y-3">
                <Label className="text-[10px] font-black uppercase tracking-widest ml-1">Business Email</Label>
                <Input type="email" placeholder="admin@zipha.com" className="h-14 rounded-2xl bg-background/50 border-border/50 font-bold" />
              </div>
              ...
              <div className="pt-4 space-y-4">
                ...
                <p className="text-[9px] font-bold text-center text-muted-foreground uppercase tracking-tight leading-relaxed px-10">
                  After clicking, you will be redirected to the Zipha Bot to finalize your identity verification and cluster payment.
                </p>
              </div>
      ...
      <div className="mt-16 flex items-center gap-6 opacity-40">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[8px] font-black uppercase tracking-widest">Instant Deployment</span>
        </div>
        <div className="flex items-center gap-2">
          <Check className="h-3 w-3 text-emerald-500" />
