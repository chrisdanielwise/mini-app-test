...
/**
 * ✅ FIX: TS7006 - Defined strict interface for the Tier manifest
 */
...
export default function RegisterPage() {
  ...
  // ✅ FIX: Strongly typed Tier array
  const availableTiers: RegistrationTier[] = [
    {
      id: "starter-tier-id",
      name: "Starter",
      price: "49.00",
  ...
  if (!isReady) return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center gap-4">
      ...
      <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/10">Synchronizing_Hardware...</p>
    </div>
  );

  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background relative overflow-hidden leading-none selection:bg-primary/20">
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-700">
            <div className="p-3 bg-zinc-950/40 border border-white/5 rounded-2xl backdrop-blur-xl shadow-2xl">
              <TierSelector
                ...
                // ✅ FIX: Explicit parameter typing to resolve TS7006
                onSelect={(id: string) => { setSelectedTier(id); impact("light"); }}
                currency="$"
              />
            </div>
