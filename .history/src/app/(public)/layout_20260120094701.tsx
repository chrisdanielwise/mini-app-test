 ...
 * Fix: Eliminated 'flex-col' and 'flex-1' on the main chassis to allow 
 * natural document growth and prevent footer displacement.
 */
export default function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div 
      className={cn(
        "relative w-full bg-background text-foreground transition-colors duration-700",
        "selection:bg-primary/20 antialiased min-h-screen",
    ...
    >
      ...
      {/* 🚀 CONTENT VOLUME 
          🏁 THE FIX: Changed from 'flex-1' to standard 'block'. 
          This allows the main content to push the footer down naturally.
      */}
      
      <main className="w-full relative z-10 block overflow-visible">
        {children}
      </main>
