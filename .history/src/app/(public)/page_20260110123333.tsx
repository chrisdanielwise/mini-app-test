...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-background selection:bg-primary/20">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 py-32 text-center border-b border-border/40">
        ...
        <div className="space-y-4 mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
          ...
          <div className="flex items-center justify-center gap-4 opacity-20">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.6em]">Autonomous Merchant Infrastructure</p>
             <div className="h-px w-12 bg-foreground" />
          </div>
        </div>
        ...
        <p className="max-w-2xl text-lg md:text-2xl text-muted-foreground font-black uppercase tracking-tight mb-20 opacity-60 leading-tight italic">
          Architecting the future of Telegram signal broadcaters. <br />
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full max-w-3xl animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
          ...
          >
            <Link href="https://t.me/YOUR_BOT_USERNAME">
              Launch Bot <ArrowRight className="ml-4 h-6 w-6 group-hover:translate-x-2 transition-transform" />
            </Link>
          </Button>
      ...
      <section id="infrastructure" className="w-full px-8 py-20 bg-muted/5 border-b border-border/40 overflow-hidden relative">
      ...
      <section id="pricing" className="max-w-7xl mx-auto px-6 py-40 relative">
        ...
        <div className="flex flex-col items-center mb-32 text-center space-y-4">
          <div className="flex items-center gap-3 text-primary">
             ...
             <span className="text-[10px] font-black uppercase tracking-[0.5em]">Scalability Protocol</span>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-baseline gap-2 mb-16">
        {price !== "Custom" && <span className="text-4xl font-black italic tracking-tighter text-primary opacity-40">$</span>}
        <span className={cn(
        ...
        {price !== "Custom" && <span className="text-[10px] font-black uppercase text-muted-foreground opacity-30 tracking-[0.4em] ml-4">
          /NODE
        </span>}
      </div>
        ...
        {features.map((f: string) => (
          <div key={f} className="flex items-center gap-4 group/item">
            <div className={cn(
                ...
                featured ? "bg-primary/20 border-primary/40 text-primary" : "bg-muted/30 border-border/40 text-muted-foreground"
            )}>
