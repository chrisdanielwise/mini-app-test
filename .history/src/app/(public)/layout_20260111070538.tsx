...
/**
 * 🌐 PUBLIC TIER LAYOUT (Tactical Medium)
 * Normalized: High-density industrial scale.
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-background selection:bg-primary/20 antialiased overflow-x-hidden">
      ...
      <footer className="relative border-t border-border/10 bg-muted/5 pt-12 md:pt-16 pb-10 overflow-hidden">
        ...
        {/* Background Watermark: Subtly scaled */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
            ...
            {/* Infrastructure Manifest: Normalized Lists */}
            <div className="space-y-4 md:space-y-6">
            ...
            {/* Social Handshake: Compact Icons */}
            <div className="space-y-4 md:space-y-6">
          ...
          {/* Institutional Compliance Bar: Normalized */}
