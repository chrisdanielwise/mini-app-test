...
export default function LandingPage() {
  return (
    <div className="flex flex-col">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pt-32 pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full max-w-2xl">
          <Button
            asChild
            size="lg"
            className="flex-1 rounded-[2.5rem] h-24 text-md font-black uppercase italic tracking-widest shadow-2xl shadow-primary/30 transition-all hover:scale-[1.02] active:scale-95"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="flex-1 rounded-[2.5rem] h-24 text-md font-black uppercase tracking-widest border-border/60 bg-card/50 backdrop-blur-md hover:bg-muted/50 transition-all"
          >
      ...
      <section
        id="infrastructure"
        className="container mx-auto px-6 py-12 border-y border-border/40 bg-muted/5 text-center"
      >
      ...
      <section
        id="pricing"
        className="container mx-auto px-6 py-40 border-t border-border/40 relative"
      >
...
function PricingCard({ name, price, desc, features, featured }: any) {
  return (
    <Card
      className={`rounded-[3.5rem] p-12 flex flex-col relative transition-all duration-500 ${
        featured
          ? "border-primary border-2 shadow-2xl shadow-primary/10 bg-card scale-105 z-10"
    ...
    >
      <div className="mb-10">
        ...
        <p className="text-[10px] font-black text-muted-foreground mt-2 uppercase tracking-widest opacity-60">
          {desc}
        </p>
      </div>
      ...
      <div className="flex items-baseline gap-1 mb-12">
        ...
        <span className="text-8xl font-black italic tracking-tighter leading-none">
          {price}
        </span>
        <span className="text-xs font-black uppercase text-muted-foreground opacity-50 tracking-widest ml-3">
          /mo
        </span>
      </div>
      ...
      <Button
        asChild
        className={`w-full h-16 rounded-2xl font-black uppercase italic tracking-widest text-xs ${
          featured
