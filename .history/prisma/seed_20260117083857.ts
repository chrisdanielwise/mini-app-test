...
const greyMerchant: any = await retry(() => 
  prisma.merchantProfile.upsert({
    ...
    create: {
      ...
      // Ensure the planId matches a plan that actually exists in your DB
      planId: enterprisePlan.id, 
      botId: 6838294498n,
      botToken: "6838294498:AAHR907AbARqogosjcVtSscTyhBWHiGYQDc",
      // ✅ FIXED: Use the Enum object and cast to bypass runtime mismatch
      planStatus: SubscriptionStatus.ACTIVE as any, 
