...
await retry(() =>
  prisma.webhookEvent.create({
    data: {
      ...
      // ✅ FIXED: Payload is mandatory for required Json fields
      payload: { 
        id: "evt_test_123", 
        object: "event", 
        reason: "card_declined" 
      },
      // ✅ FIXED: Using Double-Cast for Enum safety
      status: "FAILED" as unknown as any, 
  ...
  await retry(() =>
    prisma.verificationDocument.create({
      data: {
        ...
        status: "APPROVED" as unknown as SubscriptionType.APPROVED,
      },
    })
  );
