      ...
      tiers: [
        {
          name: "1 Month Access",
          price: 52.0,
          interval: "MONTH" as unknown as IntervalUnit,
          intervalCount: 1,
          type: "CUSTOM" as unknown as SubscriptionType,
        },
        {
          name: "12 Months Access",
          price: 400.0,
          interval: "YEAR" as unknown as IntervalUnit,
          intervalCount: 1,
          type: "CUSTOM" as unknown as SubscriptionType,
        },
      ],
            ...
            create: {
              status:
                scenario === "FRAUD" || scenario === "CHURNED"
                  ? ("INACTIVE" as unknown as SubscriptionStatus)
                  : ("ACTIVE" as unknown as SubscriptionStatus),
      ...
      const p = await retry(() =>
        prisma.payment.create({
          data: {
            ...
            amount: tierPrice,
            currency: "USD",
            status: "REFUNDED" as unknown as PaymentStatus,
          },
        })
      );
      await retry(() =>
      ...
      await retry(() =>
        prisma.screenshot.create({
          data: {
            userId: user.id,
            merchantId: merchantData.profile.id,
            photoId: faker.string.alphanumeric(10),
            status: "PENDING" as unknown as PaymentStatus,
            packageType: "VIP",
            paymentType: "USDT",
          },
        })
