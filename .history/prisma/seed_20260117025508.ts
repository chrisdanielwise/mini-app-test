...
const greyUser = await retry(() => prisma.user.upsert({
  ...
  update: {}, // If you want to update the role if they exist, add it here
  create: {
    telegramId: 994858530n,
    fullName: 'GreysuitFx Admin',
    role: UserRole.MERCHANT as UserRole, // ✅ Use the imported object
    email: 'admin@greysuitfx.com',
    language: LanguageCode.EN // ✅ Use the imported object
  }
}));
