 ...
 * Fix: High-density balance nodes and compressed inputs prevent viewport blowout.
 */
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-4 mb-8 relative z-10">
          ...
          <div className="leading-none">
            <h3 className="text-lg md:text-xl font-black uppercase italic tracking-tighter text-foreground">Settlement_Handshake</h3>
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between px-1">
        <label className="text-[7.5px] font-black uppercase tracking-[0.3em] text-primary/40 italic">{label}</label>
        {isMax && (
          <button onClick={onMax} className="text-[7px] font-black uppercase tracking-widest text-primary hover:text-foreground transition-colors italic">MAX_SETTLE</button>
        )}
      </div>
